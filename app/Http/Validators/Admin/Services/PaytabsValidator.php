    ...
    static function validate($request)
    {
        try {
            ...
            $rules    = [
                ...
                'profile_id'    => 'required',
                'server_key'    => 'required',
                'region'        => 'required|in:ARE,EGY,SAU,OMN,JOR,GLOBAL',
            ];
            ...
            $messages = [
                ...
                'profile_id.required'    => __('messages.t_validator_required'),
                'server_key.required'    => __('messages.t_validator_required'),
                'region.required'        => __('messages.t_validator_required'),
                'region.in'              => __('messages.t_validator_in')
            ];
