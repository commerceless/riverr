...
class DocDriverValidator
{
    ...
    static function validate($request)
    {
        try {
            ...
            $data     = [
                'front' => isset($request->doc_driver_license['front']) ? $request->doc_driver_license['front'] : null,
                'back'  => isset($request->doc_driver_license['back']) ? $request->doc_driver_license['back'] : null,
            ];
