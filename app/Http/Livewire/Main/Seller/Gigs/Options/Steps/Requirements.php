...
class Requirements extends Component
{
    ...
    {
        return view('livewire.main.seller.gigs.options.steps.requirements');
    }
    ...
    {
        // Go back to preview step
        return redirect('seller/gigs/edit/' . $this->gig->uid . '?step=pricing');
    }
    ...
    public function save()
    {
        try {
            ...
            // Success
            return redirect('seller/gigs/edit/' . $this->gig->uid . '?step=gallery')->with('success', __('messages.t_requirements_section_has_been_saved'));
