...
class Pricing extends Component
{
    ...
    {
        return view('livewire.main.seller.gigs.options.steps.pricing');
    }
    ...
    {
        // Go back to preview step
        return redirect('seller/gigs/edit/' . $this->gig->uid . '?step=overview');
    }
    ...
    public function save()
    {
        try {
            ...
            // Success
            return redirect('seller/gigs/edit/' . $this->gig->uid . '?step=requirements')->with('success', __('messages.t_pricing_section_has_been_saved'));
