...
class CreateComponent extends Component
{
    ...
    public function gallery($data)
    {
        ...
        try {
            ...
            $this->vimeo_video_link = $data['vimeo_video_link'];
            $this->vimeo_video_id   = $data['vimeo_video_id'];
    ...
    public function finish()
    {
        try {
            ...
            $vimeo_video_link     = $this->vimeo_video_link ? clean($this->vimeo_video_link) : null;

            // Get vimeo video id
            $vimeo_video_id       = $this->vimeo_video_id ? clean($this->vimeo_video_id) : null;
            ...
            $gig->vimeo_video_link= $vimeo_video_link;
            $gig->vimeo_video_id  = $vimeo_video_id;
            $gig->save();
