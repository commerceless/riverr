                ...
                <div class="mx-auto max-w-7xl">
                    <div class="lg:flex lg:items-center lg:justify-between">
                        ...
                        <div class="mt-5 flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
                            ...
                            <span class="block">
                                <a href="<?php echo e(url('project/' . $project->pid . '/' . $project->slug)); ?>" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-500 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-500 focus:outline-none focus:ring-primary-600">
                                    ...
                                    <?php echo e(__('messages.t_view_project')); ?>
                        ...
                        <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                            ...
                            <thead>
                                <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="employer-dashboard-project-milestones-<?php echo e($p->uid); ?>">
                                        ...
                                        <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                            <div class="flex items-center justify-center space-x-2 rtl:space-x-reverse">
                                                ...
                                                <button wire:click="details('<?php echo e($p->uid); ?>')" type="button" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 text-sm rounded border-gray-300 bg-white text-gray-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-transparent dark:text-zinc-200 dark:hover:bg-zinc-600" data-tooltip-target="tooltip-actions-details-<?php echo e($p->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-details-'.e($p->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_details'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                ...
                                                <?php if($p->status === 'request'): ?>
                                                    <button wire:click="confirmPay('<?php echo e($p->uid); ?>')" type="button" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 text-sm rounded border-gray-300 bg-white text-gray-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-transparent dark:text-zinc-200 dark:hover:bg-zinc-600" data-tooltip-target="tooltip-actions-pay-<?php echo e($p->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-pay-'.e($p->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_deposit_funds'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php endif; ?>
                                                ...
                                                <?php if($p->status === 'funded'): ?>
                                                    <button wire:click="confirmRelease('<?php echo e($p->uid); ?>')" type="button" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 text-sm rounded border-gray-300 bg-white text-gray-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none" data-tooltip-target="tooltip-actions-release-<?php echo e($p->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-awarded-bid-container-'.e($project->uid).'','target' => 'modal-awarded-bid-button-'.e($project->uid).'','uid' => 'modal_awarded_bid_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>

        
         <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_awarded_bid')); ?> <?php $__env->endSlot(); ?>
                ...
                <div class="relative">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                              ...
                              <a href="<?php echo e(url('profile', $project->awarded_bid->user->username)); ?>" class="block">
                                <img class="rounded-full h-12 w-12 object-cover object-center lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($project->awarded_bid->user->avatar)); ?>" alt="<?php echo e($project->awarded_bid->user->username); ?>">
                            </a>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <?php if($project->awarded_bid->user->fullname): ?>
                                        <span class="font-medium text-zinc-900 text-sm hover:text-black dark:text-zinc-200 dark:hover:text-white ltr:pr-1 rtl:pl-1">
                                            <?php echo e($project->awarded_bid->user->fullname); ?>

                                        </span>
                                    <?php endif; ?>
                
                                    
                                    <a href="<?php echo e(url('profile', $project->awarded_bid->user->username)); ?>" class="font-medium text-gray-500 text-[13px] hover:text-primary-600 focus:text-primary-600 inline-flex items-center dark:text-zinc-400">
                                        ...
                                        <span><?php echo e($project->awarded_bid->user->username); ?></span>
                                    </a>
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px] dark:text-zinc-400">
                                    ...
                                    <?php if($project->awarded_bid->user->country): ?>
                                        <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                            <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(countryFlag($project->awarded_bid->user->country->code)); ?>" alt="<?php echo e($project->awarded_bid->user->country->name); ?>">
                                            <span><?php echo e($project->awarded_bid->user->country->name); ?></span>
                                        </p>
                                    ...
                                    <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                        <svg aria-hidden="true" class="w-4 h-4 <?php echo e($project->awarded_bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500'); ?> -mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                        <span>
                                            <?php echo e($project->awarded_bid->user->rating()); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-create-milestone-container-'.e($project->uid).'','target' => 'modal-create-milestone-button-'.e($project->uid).'','uid' => 'modal_create_milestone_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

            
             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_create_milestone_payment')); ?> <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_amount')),'placeholder' => '0.00','model' => 'milestone_amount','suffix' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(settings('currency')->code),'hint' => ''.e(__('messages.t_available_balance')).' '.e(money(convertToNumber(auth()->user()->balance_available), settings('currency')->code, true)).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/account/projects/options/milestones.blade.php ENDPATH**/ ?>