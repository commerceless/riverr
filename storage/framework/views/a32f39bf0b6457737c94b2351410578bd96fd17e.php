    ...
    <div class="px-4 md:px-3 py-4 md:py-5 bg-white border !border-b-0 dark:bg-gray-700 rounded-tl-lg rounded-tr-lg">
        <div class="sm:flex items-center justify-between">
            <p class="text-sm font-bold leading-wide text-gray-800">
                <?php echo e(__('messages.t_countries')); ?>

            </p>
            <div>
                <a href="<?php echo e(admin_url('countries/create')); ?>" class="focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start px-6 py-3 bg-primary-600 hover:bg-primary-700 focus:outline-none rounded-sm">
        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0"
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_country')); ?></th>
                    ...
                    <tr class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
                        ...
                        <td class="ltr:pl-4 rtl:pr-4">
                            <div class="flex items-center">
                                <div class="w-10 h-10">
                                    <img class="w-full h-full lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('public/img/flags/rounded/' . strtolower($country->code) . '.svg')); ?>" alt="<?php echo e($country->name); ?>" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <p class="font-medium"><?php echo e($country->name); ?></p>
                                    <p class="text-xs leading-3 text-gray-600 pt-2"><?php echo e($country->code); ?></p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="relative inline-block text-left">
                                ...
                                <div id="table-options-dropdown-<?php echo e($country->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">

                                        
                                        <a href="<?php echo e(admin_url('countries/edit/' . $country->id)); ?>" class="text-gray-800 dark:text-gray-300 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                            ...
                                            <span class="text-xs font-medium"><?php echo e(__('messages.t_edit_country')); ?></span>
                                        </a>
...
<?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/countries/countries.blade.php ENDPATH**/ ?>