...
<head>
    ...
    <title><?php echo e(config('maintenance.headline')); ?></title>
                ...
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                        <h1 class="text-2xl font-extrabold text-gray-900 sm:text-3xl uppercase tracking-widest">
                            <?php echo e(config('maintenance.headline')); ?>

                        </h1>
                        <p class="mt-1 text-base text-gray-500">
                            <?php echo e(config('maintenance.message')); ?>
...
<?php /**PATH /var/www/html/riverr/resources/views/errors/503.blade.php ENDPATH**/ ?>