    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-5 gap-y-6">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="selected_payment_method_paypal" class="flex items-center ltr:ml-3 rtl:mr-3 cursor-pointer">
                                        <span class="block text-sm font-semibold text-zinc-700 dark:text-zinc-200"> 
                                            <?php echo e(settings('paypal')->name); ?>    
                                        </span>
                                    </label>
                                </div>
                            <?php endif; ?>
            ...
            <div class="w-full relative h-fit">
                ...
                <div class="rounded-lg bg-white shadow-sm border-gray-200 border relative mb-4 dark:bg-zinc-800 dark:shadow-none px-4 py-5 sm:px-6 <?php echo e($subscription->bid->is_highlight ? 'ltr:border-l-8 rtl:border-l-8 border-amber-300 dark:border-zinc-600' : ''); ?>">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            ...
                            <a href="<?php echo e(url('profile', $subscription->bid->user->username)); ?>" target="_blank" class="block">
                                <img class="rounded-full h-12 w-12 object-cover object-center" src="<?php echo e(src($subscription->bid->user->avatar)); ?>" alt="<?php echo e($subscription->bid->user->username); ?>">
                            </a>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <?php if($subscription->bid->user->fullname): ?>
                                        <span class="font-medium text-zinc-900 text-sm hover:text-black dark:text-zinc-200 ltr:pr-1 rtl:pl-1">
                                            <?php echo e($subscription->bid->user->fullname); ?>

                                        </span>
                                    <?php endif; ?>
                
                                    
                                    <a href="<?php echo e(url('profile', $subscription->bid->user->username)); ?>" class="font-medium text-gray-500 text-[13px] hover:text-primary-600 focus:text-primary-600 inline-flex items-center">
                                        ...
                                        <span><?php echo e($subscription->bid->user->username); ?></span>
                                    </a>
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px] dark:text-zinc-400">
                                    ...
                                    <?php if($subscription->bid->user->country): ?>
                                        <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                            <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(countryFlag($subscription->bid->user->country->code)); ?>" alt="<?php echo e($subscription->bid->user->country->name); ?>">
                                        </p>
                                    ...
                                    <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                        <svg aria-hidden="true" class="w-4 h-4 <?php echo e($subscription->bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500'); ?> -mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                        <span>
                                            <?php echo e($subscription->bid->user->rating()); ?>
                                    ...
                                    <span class="flex items-center text-sm font-normal text-gray-500 dark:text-zinc-400 bg-gray-100 dark:bg-zinc-700 px-3 py-2 rounded-md">
                                        ...
                                        <div>
                                            <?php if($subscription->bid->days === 1): ?>
                                                <?php echo e($subscription->bid->days); ?> <?php echo e(strtolower(__('messages.t_day'))); ?>

                                            <?php else: ?>
                                                <?php echo e($subscription->bid->days); ?> <?php echo e(strtolower(__('messages.t_days'))); ?>
                    ...
                    <div class="mt-6 flex justify-between items-center">
                        ...
                        <aside class="flex items-center mt-3 space-x-5 rtl:space-x-reverse text-xs text-gray-500 dark:text-zinc-300">
                            ...
                            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                ...
                                <span><?php echo e(format_date($subscription->bid->created_at, 'ago')); ?></span>
                            </div>
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-zinc-700 text-sm lg:mt-0">
                            ...
                            <?php if($sponsored): ?>
                                <div class="pb-4 flex items-center justify-between">
                                    <dt class="text-gray-600 dark:text-zinc-300">
                                        <span class="font-semibold px-3 py-1 rounded-sm text-[13px] tracking-wide" style="color: <?php echo e($sponsored->badge_text_color); ?>;background-color: <?php echo e($sponsored->badge_bg_color); ?>">
                                            <?php echo e(__('messages.t_' . $sponsored->plan_type)); ?>

                                        </span>
                                        <p class="text-[13px] mt-2">
                                            <?php echo e(__('messages.t_bidding_plan_' . $sponsored->plan_type . '_subtitle')); ?>
                        ...
                        <?php if($subscription->bid?->is_sealed): ?>
                            ...
                            <?php if($sealed): ?>
                                <div class="py-4 flex items-center justify-between">
                                    <dt class="text-gray-600 dark:text-zinc-300">
                                        <span class="font-semibold px-3 py-1 rounded-sm text-[13px] tracking-wide" style="color: <?php echo e($sealed->badge_text_color); ?>;background-color: <?php echo e($sealed->badge_bg_color); ?>">
                                            <?php echo e(__('messages.t_' . $sealed->plan_type)); ?>

                                        </span>
                                        <p class="text-[13px] mt-2">
                                            <?php echo e(__('messages.t_bidding_plan_' . $sealed->plan_type . '_subtitle')); ?>
                        ...
                        <?php if($subscription->bid?->is_highlight): ?>
                            ...
                            <?php if($highlight): ?>
                                <div class="py-4 flex items-center justify-between">
                                    <dt class="text-gray-600 dark:text-zinc-300">
                                        <span class="font-semibold px-3 py-1 rounded-sm text-[13px] tracking-wide" style="color: <?php echo e($highlight->badge_text_color); ?>;background-color: <?php echo e($highlight->badge_bg_color); ?>">
                                            <?php echo e(__('messages.t_' . $highlight->plan_type)); ?>

                                        </span>
                                        <p class="text-[13px] mt-2">
                                            <?php echo e(__('messages.t_bidding_plan_' . $highlight->plan_type . '_subtitle')); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/projects/bids/options/checkout.blade.php ENDPATH**/ ?>