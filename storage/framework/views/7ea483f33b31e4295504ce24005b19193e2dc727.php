        ...
        <nav class="justify-between px-4 py-3 text-gray-700 border border-gray-100 rounded-lg shadow-sm sm:flex sm:px-5 bg-white dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none" aria-label="Breadcrumb">
            ...
            <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 md:rtl:space-x-reverse sm:mb-0">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg aria-hidden="true" class="w-4 h-4 text-gray-400 rtl:rotate-180" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <a href="<?php echo e(url('seller/refunds')); ?>" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ltr:ml-2 md:rtl:mr-2 dark:text-zinc-300 dark:hover:text-white">
            ...
            <div>
                <?php if($refund->status === 'pending'): ?>
                    ...
                    <span class="ltr:ml-3 rtl:mr-3">
                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_give_refund')); ?>') ? $wire.accept() : ''" wire:loading.attr="disabled" wire:target="accept()" type="button" class="inline-flex items-center px-4 py-3 border border-transparent text-xs leading-4 font-bold tracking-wide rounded-sm text-green-700 bg-green-200 hover:bg-green-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    ...
                    <span class="ltr:ml-3 rtl:mr-3">
                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_decline_refund')); ?>') ? $wire.decline() : ''" wire:loading.attr="disabled" wire:target="decline()" type="button" class="inline-flex items-center px-4 py-3 border border-transparent text-xs leading-4 font-bold tracking-wide rounded-sm text-red-700 bg-red-200 hover:bg-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                ...
                <div class="bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm rounded-md overflow-hidden border border-gray-100">
                    <div class="divide-y divide-gray-200 dark:divide-zinc-700">
                        <div class="px-4 py-5 sm:px-6">
                            <h2 class="text-sm font-semibold tracking-wide text-gray-700 dark:text-gray-100"><?php echo e(__('messages.t_conversation')); ?></h2>
                        </div>
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                                ...
                                                <div class="relative">
                                                    <img class="h-10 w-10 rounded-full bg-gray-400 dark:bg-zinc-700 flex items-center justify-center ring-8 ring-white dark:ring-transparent object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e($msg->author_type === 'buyer' ? src($msg->buyer->avatar) : src($msg->seller->avatar)); ?>" alt="<?php echo e($msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username); ?>">
                                                </div>
                                                <div class="min-w-0 flex-1">
                                                    <div>
                                                        <div class="text-sm">
                                                            <a href="<?php echo e(url('profile', $msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username)); ?>"
                                                                target="_blank" class="font-medium text-gray-900 dark:text-gray-100 hover:text-primary-600"><?php echo e($msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username); ?></a>
                                                        </div>
                ...
                <div class="space-y-6 pb-16">
                    ...
                    <div class="mb-14">
                        <div class="aspect-w-10 aspect-h-7 block w-full overflow-hidden rounded-md">
                            <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($refund->item->gig->thumbnail)); ?>" alt="<?php echo e($refund->item->gig->title); ?>" class="lazy object-cover">
                        </div>
                        <div class="mt-4">
                            <div>
                                <a href="<?php echo e(url('service', $refund->item->gig->slug)); ?>" target="_blank" class="text-base font-bold tracking-wide text-gray-900 dark:text-gray-200 hover:text-primary-600">
                                    <?php echo e($refund->item->gig->title); ?>
                    ...
                    <div>
                        ...
                        <dl class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200 dark:divide-zinc-600 dark:border-zinc-600">
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_refund_status')); ?></dt>
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_amount')); ?></dt>
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                ...
                                <dd class="text-gray-900 dark:text-gray-200"><?php echo e(format_date($refund->created_at, 'ago')); ?></dd>
                            </div>
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                ...
                                <dd class="text-primary-700">
                                    <a href="<?php echo e(url('profile', $refund->buyer->username)); ?>" target="_blank"><?php echo e($refund->buyer->username); ?></a>
                                </dd>
                            </div>
                    ...
                    <div>
                        <h3 class="text-gray-900 dark:text-gray-300 text-sm font-bold tracking-wide"><?php echo e(__('messages.t_refund_reason')); ?></h3>
                        <div class="mt-2">
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/refunds/options/details.blade.php ENDPATH**/ ?>