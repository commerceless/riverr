<div class="messenger-sendCard" x-data="window.ieFgUjXUHsNGdOd" x-init="initialize">
    ...
    <form id="message-form" method="POST" action="<?php echo e(route('send.message')); ?>" enctype="multipart/form-data" class="items-center">
...
<?php endif; ?>
        ...
        <?php if(settings('live_chat')->enable_attachments): ?>
            <label id="attachment-file-btn">
                ...
                <input disabled='disabled' type="file" class="upload-attachment" name="file" accept=".<?php echo e(implode(', .',config('chatify.attachments.allowed_images'))); ?>, .<?php echo e(implode(', .',config('chatify.attachments.allowed_files'))); ?>" />
            </label>
            <?php if (isset($component)) { $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4 = $component; } ?>
<?php $component = App\View\Components\Forms\Tooltip::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.tooltip'); ?>
    ...
    function ieFgUjXUHsNGdOd() {
        return {
            ...
            emojis() {
                ...
                const options = { 
                    set            : 'twitter',
                    theme          : "<?php echo e(current_theme()); ?>",
                    dynamicWidth   : true,
                    previewPosition: 'none',
                    i18n           : {
                        "rtl"                : <?php echo e(config()->get('direction') === 'rtl' ? 1 : 0); ?>,
                        "search"             : "<?php echo e(__('messages.t_search')); ?>",
                        "search_no_results_1": "<?php echo e(__('messages.t_oops')); ?>",
                        "search_no_results_2": "<?php echo e(__('messages.t_no_results_found')); ?>",
                        "pick"               : "<?php echo e(__('messages.t_pick_an_emoji')); ?>",
                        "add_custom"         : "Add custom emoji",
                        "categories"         : {
                            "activity": "<?php echo e(__('messages.t_emojis_activity')); ?>",
                            "custom"  : "<?php echo e(__('messages.t_emojis_custom')); ?>",
                            "flags"   : "<?php echo e(__('messages.t_emojis_flags')); ?>",
                            "foods"   : "<?php echo e(__('messages.t_emojis_food_drink')); ?>",
                            "frequent": "<?php echo e(__('messages.t_emojis_recently_used')); ?>",
                            "nature"  : "<?php echo e(__('messages.t_emojis_animals_nature')); ?>",
                            "objects" : "<?php echo e(__('messages.t_emojis_objects')); ?>",
                            "people"  : "<?php echo e(__('messages.t_emojis_smileys')); ?>",
                            "places"  : "<?php echo e(__('messages.t_emojis_travel')); ?>",
                            "search"  : "<?php echo e(__('messages.t_search_results')); ?>",
                            "symbols" : "<?php echo e(__('messages.t_emojis_symbols')); ?>"
                        },
                        "skins": {
                            "choose": "<?php echo e(__('messages.t_choose_default_skin_tone')); ?>",
                            "1"     : "<?php echo e(__('messages.t_skin_default')); ?>",
                            "2"     : "<?php echo e(__('messages.t_skin_light')); ?>",
                            "3"     : "<?php echo e(__('messages.t_skin_medium_light')); ?>",
                            "4"     : "<?php echo e(__('messages.t_skin_medium')); ?>",
                            "5"     : "<?php echo e(__('messages.t_skin_medium_dark')); ?>",
                            "6"     : "<?php echo e(__('messages.t_skin_dark')); ?>"
                        }
                    },
                    exceptEmojis: [
                        'relaxed',
...
</script><?php /**PATH /var/www/html/riverr/resources/views/vendor/Chatify/layouts/sendForm.blade.php ENDPATH**/ ?>