            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate sm:mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="freelancer-dashboard-gigs-<?php echo e($gig->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($gig->thumbnail)); ?>" alt="<?php echo e($gig->title); ?>">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(url('service', $gig->slug)); ?>" class="font-medium whitespace-nowrap truncate block max-w-[240px] hover:text-primary-600 dark:text-white text-sm" title="<?php echo e($gig->title); ?>">
                                        ...
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-2">
                                            <nav class="flex" aria-label="Breadcrumb">
                                                <ol role="list" class="flex items-center space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <li>
                                                        <div class="flex items-center">
                                                            <a href="<?php echo e(url('categories', $gig->category->slug)); ?>" target="_blank" class="text-xs font-normal text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100"><?php echo e($gig->category->name); ?></a>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="<?php echo e(url('categories/' . $gig->category->slug . '/' . $gig->subcategory->slug)); ?>" target="_blank" class="ltr:ml-1 rtl:mr-1 text-xs font-normal text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100" aria-current="page"><?php echo e($gig->subcategory->name); ?></a>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                ...
                                <div class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap"><?php echo e(__('messages.t_number_days_for_delivery', ['number' => $gig->delivery_time])); ?></div>
                            </td>

                            
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex items-center justify-center mb-2 z-0" data-rating-value="<?php echo e($gig->rating); ?>">
                                    <?php echo render_star_rating($gig->rating, "0.85rem", "0.85rem", "#d0d0d0"); ?>

                                </div>
                                <div class="text-xs text-gray-400 tracking-wide font-normal mt-2.5 whitespace-nowrap"><?php echo e(__('messages.t_number_reviews', ['number' => number_format($gig->counter_reviews)])); ?></div>
                            </td>

                            
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <span class="text-gray-900 dark:text-gray-100 text-sm font-black"><?php echo e(number_format($gig->counter_sales)); ?></span>
                                <?php if($gig->orders_in_queue == 1): ?>
                                    <p class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap"><?php echo e(__('messages.t_number_order_in_queue', ['number' => $gig->orders_in_queue])); ?></p>
                                <?php else: ?>
                                    <p class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap"><?php echo e(__('messages.t_number_orders_in_queue', ['number' => $gig->orders_in_queue])); ?></p>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                ...
                                <div class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap">
                                    <?php echo e(number_format($gig->counter_impressions)); ?> <?php echo e(strtolower(__('messages.t_impressions'))); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-edit-'.e($gig->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_edit'))]); ?>
...
<?php endif; ?>
                                    ...
                                    <a href="<?php echo e(url('seller/gigs/analytics', $gig->uid)); ?>" data-tooltip-target="tooltip-actions-analytics-<?php echo e($gig->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-analytics-'.e($gig->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_analytics'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php endif; ?>
                                    ...
                                    <button wire:click="confirmDelete('<?php echo e($gig->uid); ?>')" type="button" data-tooltip-target="tooltip-actions-delete-<?php echo e($gig->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-'.e($gig->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-delete-gig-container-'.e($gig->uid).'','target' => 'modal-delete-gig-button-'.e($gig->uid).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_delete')); ?> " <?php echo e($gig->title); ?> " <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('content', null, []); ?> 
                                    ...
                                    <div>
                                        <button 
                                            wire:click="delete(<?php echo e($gig->id); ?>)"
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/gigs/gigs.blade.php ENDPATH**/ ?>