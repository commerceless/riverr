<div class="max-w-5xl mx-auto">
    ...
    <nav class="flex mt-6" aria-label="Breadcrumb">
        <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
                <div>
                    <a href="<?php echo e(url('/')); ?>" class="text-gray-400 dark:text-gray-200 hover:text-gray-500 dark:hover:text-gray-100">
            ...
            <li>
                <div class="flex items-center">                    
                    ...
                    <a href="<?php echo e(url('blog')); ?>" class="ltr:ml-4 rtl:mr-4 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-200 dark:hover:text-gray-100"><?php echo e(__('messages.t_blog')); ?></a>
                </div>
            </li>
    ...
    <div class="relative py-16 mt-6 bg-white dark:bg-zinc-800 overflow-hidden rounded-lg shadow">
        ...
        <div class="relative px-4 sm:px-6 lg:px-8 ql-snow">
            <div class="text-lg max-w-prose mx-auto ql-editor">
                ...
                <h1 class="mb-6">
                    <span class="block text-xs text-center text-primary-600 font-semibold tracking-wide uppercase"><?php echo e(__('messages.t_x_min_read', ['x' => $article->reading_time])); ?></span>
                    <span class="mt-2 block text-xl text-center leading-8 font-extrabold tracking-tight text-gray-900 dark:text-gray-100 sm:text-2xl"><?php echo e($article->title); ?></span>
                </h1>

                
                <figure>
                    <img class="w-full rounded-lg lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($article->image)); ?>" alt="<?php echo e($article->title); ?>">
                </figure>
                ...
                <span class="text-center font-medium text-gray-800 dark:text-gray-300 text-sm mb-4 mt-24 flex items-center justify-center"><?php echo e(__('messages.t_share')); ?></span>
                <div class="flex items-center justify-center pb-6">

                    
                    <a href="https://www.facebook.com/sharer.php?t=<?php echo e($article->title); ?>&u=<?php echo e(url('blog', $article->slug)); ?>" target="_blank" data-tooltip-target="project-share-facebook" class="text-white bg-[#4267B2] hover:bg-[#4267B2]/80 focus:ring-0 focus:outline-none rounded-full flex items-center justify-center h-12 w-12 mr-2">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=<?php echo e($article->title); ?>&url=<?php echo e(url('blog', $article->slug)); ?>" target="_blank" data-tooltip-target="project-share-twitter" class="text-white bg-[#00acee] hover:bg-[#00acee]/80 focus:ring-0 focus:outline-none rounded-full flex items-center justify-center h-12 w-12 mr-2">
                    ...
                    <a href="https://www.linkedin.com/shareArticle?title=<?php echo e($article->title); ?>&url=<?php echo e(url('blog', $article->slug)); ?>" target="_blank" data-tooltip-target="project-share-linkedin" class="text-white bg-[#0072b1] hover:bg-[#0072b1]/80 focus:ring-0 focus:outline-none rounded-full flex items-center justify-center h-12 w-12 mr-2">
                    ...
                    <a href="https://snapchat.com/scan?attachmentUrl=<?php echo e(url('blog', $article->slug)); ?>" target="_blank" data-tooltip-target="project-share-snapchat" class="text-gray-700 bg-[#FFFC00] hover:bg-[#FFFC00]/80 focus:ring-0 focus:outline-none rounded-full flex items-center justify-center h-12 w-12 mr-2">
                    ...
                    <a href="https://www.pinterest.com/pin/create/button/?description=<?php echo e($article->title); ?>&media=&url=<?php echo e(url('blog', $article->slug)); ?>" target="_blank" data-tooltip-target="project-share-pinterest" class="text-white bg-[#E60023] hover:bg-[#E60023]/80 focus:ring-0 focus:outline-none rounded-full flex items-center justify-center h-12 w-12 mr-2">
                    ...
                    <a href="https://web.whatsapp.com/send?text=<?php echo e(url('blog', $article->slug)); ?>" target="_blank" data-tooltip-target="project-share-whatsapp" class="text-white bg-[#25D366] hover:bg-[#25D366]/80 focus:ring-0 focus:outline-none rounded-full flex items-center justify-center h-12 w-12 mr-2">
        ...
        <div class="bg-white dark:bg-zinc-800 shadow rounded-lg sm:overflow-hidden mt-10">
            <div class="divide-y divide-gray-200 dark:divide-zinc-700">
                <div class="px-4 py-5 sm:px-6">
                    <h2 class="text-base font-bold tracking-wide text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_comments')); ?></h2>
                </div>
                        ...
                        <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <div class="flex space-x-3">
                                    <div class="flex-shrink-0">
                                        <span class="inline-flex items-center justify-center h-10 w-10 rounded-full bg-gray-500 dark:bg-zinc-700">
                                            <span class="font-medium leading-none text-white">
                                                <?php echo e(mb_substr($cm->name, 0, 1)); ?>
                                    ...
                                    <div>
                                        <div class="text-sm">
                                            <span class="font-bold text-gray-900 dark:text-gray-100"><?php echo e($cm->name); ?></span>
                                        </div>
                                        <div class="mt-1 text-sm text-gray-700 dark:text-gray-300">
                                            <p>
                                                <?php echo e($cm->comment); ?>

                                            </p>
                                        </div>
                                        <div class="mt-2 text-xs">
                                            <span class="text-gray-400 font-medium"><?php echo e(format_date($cm->created_at, 'ago')); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <div class="mt-6 flex items-center justify-between">
                                ...
                                <button 
                                    ...
                                    <div wire:loading.remove wire:target="addComment">
                                        <?php echo e(__('messages.t_add_comment')); ?>
...
<?php $component = Lukeraymonddowning\Honey\Views\Honey::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('honey'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Lukeraymonddowning\Honey\Views\Honey::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/blog/article.blade.php ENDPATH**/ ?>