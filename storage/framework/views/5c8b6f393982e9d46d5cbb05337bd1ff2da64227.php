    ...
    <div class="grid grid-cols-1 md:grid-cols-3 md:gap-5">
        ...
        <div class="bg-white shadow rounded-lg divide-y divide-gray-200 dark:divide-zinc-700 md:col-span-2 h-fit">
            <div class="py-10 px-12">
                ...
                <div class="mb-14">
                    <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_edit_projects_category')); ?></h2>
                </div>
...
<?php endif; ?>
                        ...
                        <?php if($category->thumbnail): ?>
                            <div class="mt-3">
                                <img src="<?php echo e(src( $category->thumbnail )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?>
                        ...
                        <?php if($category->ogimage): ?>
                            <div class="mt-3">
                                <img src="<?php echo e(src( $category->ogimage )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?>
        ...
        <div class="col-span-1">
            ...
            <h3 class="font-semibold mb-3"><?php echo e(__('messages.t_translations')); ?></h3>
            ...
            <?php if(count($translations)): ?>
                <ul class="bg-white shadow rounded-lg divide-y divide-gray-200" wire:key='sdfsdfsdf'>
                    <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="p-4 flex justify-between items-center" wire:key="translations-<?php echo e($key); ?>">
                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                
                                
                                <?php if($language): ?>
                                    <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('public/img/flags/rounded/' . $language->country_code . '.svg')); ?>" alt="<?php echo e($language->name); ?>" class="inline-block w-10 h-10 rounded-full lazy" />
                                <?php endif; ?>

                                <div>
                                    <p class="font-semibold text-[13px]">
                                        <?php echo e($value['language_value']); ?>

                                    </p>
                                    <p class="font-medium text-xs text-gray-500 mt-1">
                                        <?php echo e($language ? $language->name : $value['language_code']); ?>
                            ...
                            <div class="flex justify-end">
                                <button wire:click="deleteTranslation('<?php echo e($key); ?>')" wire:loading.class="cursor-not-allowed"
                                wire:loading.attr="disabled" class="h-8 w-8 p-0 text-red-600 flex items-center justify-center">

                                    
                                    <div wire:loading wire:target="deleteTranslation('<?php echo e($key); ?>')">
                                    ...
                                    <div wire:loading.remove wire:target="deleteTranslation('<?php echo e($key); ?>')">
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-1 text-xs text-red-600 dark:text-red-500"><?php echo e($errors->first('translation_language_code')); ?></p>
                        <?php unset($message);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-5 gap-y-5 mt-6">
                        ...
                        <div>
                            <button x-on:click="new_translation = false" class="w-full text-[13px] font-semibold flex justify-center bg-transparent hover:bg-gray-300 text-gray-800 py-4 px-8 rounded tracking-wide focus:outline-none focus:shadow-outline cursor-pointer">
                                <?php echo e(__('messages.t_cancel')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'addTranslation','text' => ''.e(__('messages.t_add')).'','block' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal49b2fc8ba42c39d638e648b21b88e1b33ae2822c)): ?>
<?php $component = $__componentOriginal49b2fc8ba42c39d638e648b21b88e1b33ae2822c; ?>
...
<?php endif; ?>
                ...
                <button wire:key='qsdqsdqsdqs' x-on:click="new_translation = !new_translation" type="button" class="bg-slate-200 mt-6 inline-flex justify-center items-center space-x-2 border font-semibold focus:outline-none w-full px-3 py-2 leading-5 text-xs rounded border-transparent text-gray-600 hover:text-gray-400 focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:text-gray-600">
                    ...
                    <span><?php echo e(__('messages.t_add_new_translation')); ?></span>
                </button>
...
</div>    <?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/projects/categories/options/edit.blade.php ENDPATH**/ ?>