    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            ...
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                        
                <div class="relative flex flex-col break-words rounded-xl shadow-sm" wire:key="freelancer-portfolio-<?php echo e($project->uid); ?>">

                    
                    <img class="h-72 w-full rounded-lg object-cover object-center" src="<?php echo e(src($project->thumbnail)); ?>" alt="<?php echo e($project->title); ?>">
                    ...
                    <div class="absolute inset-0 flex h-full w-full flex-col justify-end">
                        <div class="space-y-1.5 rounded-lg bg-gradient-to-t from-[#00000091] via-[#000000cc] to-transparent px-4 pb-3 pt-12">
                            ...
                            <div class="line-clamp-2">
                                <a href="<?php echo e(url('profile/' . $project->user->username . '/portfolio/' . $project->slug)); ?>" target="_blank" class="text-base font-medium text-white">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="ltr:-mr-1.5 rtl:-ml-1.5 flex space-x-2 rtl:space-x-reverse">
                                    ...
                                    <a href="<?php echo e(url('seller/portfolio/edit', $project->uid)); ?>" class="h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 flex items-center justify-center">
                                    ...
                                    <button 
                                        x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_project')); ?>') ? $wire.delete('<?php echo e($project->uid); ?>') : ''" 
                                        wire:loading.attr="disabled" 
                                        wire:target="delete('<?php echo e($project->uid); ?>')"
                                        type="button" 
            ...
            <a href="<?php echo e(url('seller/portfolio/create')); ?>" class="h-72 rounded-xl border-dashed border-2 border-slate-200 bg-opacity-20 bg-slate-100 hover:bg-opacity-100 dark:border-zinc-600 dark:bg-zinc-800 dark:hover:bg-zinc-700 flex items-center justify-center flex-col">
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/portfolio/portfolio.blade.php ENDPATH**/ ?>