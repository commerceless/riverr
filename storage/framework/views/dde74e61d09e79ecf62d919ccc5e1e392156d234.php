<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_xendit_payment_settings')); ?></h2>
                <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.t_xendit_payment_settings_subtitle')); ?></p>
            </div>
...
<?php endif; ?>
                    ...
                    <?php if(settings('xendit')->logo): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( settings('xendit')->logo )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/services/xendit.blade.php ENDPATH**/ ?>