<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_recaptcha')); ?></h2>
                <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.t_update_recaptcha_settings')); ?></p>
            </div>
...
</div>    <?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/services/recaptcha.blade.php ENDPATH**/ ?>