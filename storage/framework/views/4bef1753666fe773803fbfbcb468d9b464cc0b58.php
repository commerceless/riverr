<div <?php echo e($attributes->only(['class', 'wire:key'])->class('relative')); ?>
        ...
        <template x-if="asyncData.api || (config.searchable && options.length >= <?php echo \Illuminate\Support\Js::from($minItemsForSearch)->toHtml() ?>)">
            <div class="px-2 my-2" wire:key="search.options.<?php echo e($name); ?>">
                <x-dynamic-component
                    ...
                    class="bg-slate-100"
                    x-ref="search"
                    x-model.debounce.<?php echo e($asyncData ? 750 : 0); ?>ms="search"
...
<?php /**PATH /var/www/html/riverr/vendor/wireui/wireui/resources/views/components/select.blade.php ENDPATH**/ ?>