        ...
        <div class="wrapper !grid md:!flex">
                        ...
                        <?php $__currentLoopData = $messages->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="chat-msg <?php echo e($msg->message_from == auth()->id() ? 'owner' : 'rtl:flex-row-reverse'); ?>" wire:key="conversation-message-<?php echo e($msg->uid); ?>">
                                <div class="chat-msg-profile">
                                    ...
                                    <div class="chat-msg-date"><?php echo e(format_date($msg->created_at, config('carbon-formats.F_j,_Y_h_:_i_A'))); ?></div>
                                </div>
            ...
            <div class="detail-area dark:border-zinc-700" wire:key="conversation-user-details">
                <div class="detail-area-header">
                    ...
                    <div class="detail-subtitle" wire:ignore><?php echo e(__('messages.t_conversation_started_on_date', ['date' => format_date($conversation->created_at, config('carbon-formats.F_j,_Y'))])); ?></div>
                ...
                <div class="detail-changes" wire:ignore>
                    ...
                    <div class="detail-change flex items-center justify-between">
                        ...
                        <span class="text-xs text-gray-800 dark:text-gray-200"><?php echo e(format_date($conversation->sender->created_at, config('carbon-formats.F_j,_Y'))); ?></span>
                    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/messages/conversation.blade.php ENDPATH**/ ?>