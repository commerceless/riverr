                ...
                <div class="ltr:ml-3 rtl:mr-3">
                    ...
                    <div class="mt-6">
                        <div class="-mx-2 -my-1.5 flex">
                            ...
                            <a href="<?php echo e(url('https://wa.me/'. config('global.whatsapp') .'/?text=Hello')); ?>" target="_blank" class="px-2 py-1.5 text-sm font-medium text-slate-800 focus:outline-none focus:ring-0 flex items-center space-x-1 rtl:space-x-reverse group">
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/projects/plans/plans.blade.php ENDPATH**/ ?>