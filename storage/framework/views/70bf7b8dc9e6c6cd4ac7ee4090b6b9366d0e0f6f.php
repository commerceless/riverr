...
<nav class="w-full <?php echo e($class ? $class : ''); ?>">
            ...
            <div class="flex-1 flex flex-col p-8">
                ...
                <h3 class="mt-6 text-gray-700 dark:text-white text-sm font-medium flex items-center justify-center">
                    ...
                    <?php if(auth()->user()->status === 'verified'): ?>
                        <img data-tooltip-target="tooltip-account-verified-<?php echo e($id); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('public/img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="<?php echo e(url('account/settings')); ?>"
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/settings') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_account_settings')); ?> </span>

        </a>

        
        <a href="<?php echo e(url('account/profile')); ?>"
            class="<?php echo e(Request::is('account/profile') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/profile') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_edit_profile')); ?> </span>

        </a>

        
        <a href="<?php echo e(url('account/password')); ?>"
            class="<?php echo e(Request::is('account/password') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/password') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_update_password')); ?> </span>
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="<?php echo e(url('account/orders')); ?>"
            class="<?php echo e(Request::is('account/orders') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/orders') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_my_orders')); ?> </span>

        </a>

        
        <a href="<?php echo e(url('inbox')); ?>"
            class="<?php echo e(Request::is('inbox') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('inbox') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_my_messages')); ?> </span>

        </a>

        
        <a href="<?php echo e(url('account/reviews')); ?>"
            class="<?php echo e(Request::is('account/reviews') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/reviews') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_my_reviews')); ?> </span>

        </a>

        
        <a href="<?php echo e(url('account/refunds')); ?>"
        ...
        <a href="<?php echo e(url('account/favorite')); ?>"
            class="<?php echo e(Request::is('account/favorite') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/favorite') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_favorite_list')); ?> </span>
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="<?php echo e(url('account/billing')); ?>"
            class="<?php echo e(Request::is('account/billing') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/billing') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_billing_information')); ?> </span>

        </a>

        
        <a href="<?php echo e(url('account/verification')); ?>"
            class="<?php echo e(Request::is('account/verification') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg xmlns="http://www.w3.org/2000/svg"
                class="<?php echo e(Request::is('account/verification') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_verification_center')); ?> </span>
    ...
    <a href="<?php echo e(url('auth/logout')); ?>"
        class="<?php echo e(Request::is('account/logout') ? $link_active_class : $link_basic_class); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

        
        <svg xmlns="http://www.w3.org/2000/svg"
            class="<?php echo e(Request::is('account/logout') ? $icon_active_class : $icon_basic_class); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5"
            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_logout')); ?> </span>

    </a>

</nav>
<?php /**PATH /var/www/html/riverr/resources/views/components/main/account/sidebar.blade.php ENDPATH**/ ?>