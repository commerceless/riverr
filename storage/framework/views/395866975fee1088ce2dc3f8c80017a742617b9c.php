            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-projects-<?php echo e($project->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <a href="<?php echo e(admin_url('users/details/' . $project->client->uid)); ?>" class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($project->client->avatar)); ?>" alt="<?php echo e($project->client->username); ?>">
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(url('project/' . $project->pid . '/' . $project->slug)); ?>" target="_blank" class="font-medium whitespace-nowrap truncate block max-w-[240px] hover:text-primary-600 dark:text-white text-sm" title="<?php echo e($project->title); ?>">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <span class="ltr:ml-1 rtl:mr-1 text-xs font-normal text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100" aria-current="page">
                                                                <div class="flex items-center space-x-2 rtl:space-x-reverse text-gray-500 text-xs">
                                                                    ...
                                                                    <div>
                                                                        <?php echo e($project->counter_views); ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="text-gray-900 dark:text-gray-100 text-sm font-bold">
                                    <?php echo e($project->milestones_count); ?>    
                                </div>
                            </td>
                                            ...
                                            <div class="bg-yellow-100 text-yellow-600 px-4 leading-9 h-9 rounded-3xl font-medium text-xs flex items-center space-x-3 rtl:space-x-reverse">
                                                ...
                                                <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" data-tooltip-target="tooltip-actions-approve-<?php echo e($project->uid); ?>" id="modal-approve-project-button-<?php echo e($project->uid); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-approve-'.e($project->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_approve'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" data-tooltip-target="tooltip-actions-reject-<?php echo e($project->uid); ?>" id="modal-reject-project-button-<?php echo e($project->uid); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-reject-'.e($project->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_reject'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="text-gray-600 dark:text-gray-100 text-sm font-medium whitespace-nowrap">
                                    <?php echo e(format_date($project->created_at)); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-milestones-'.e($project->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_milestones'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <button type="button" data-tooltip-target="tooltip-actions-delete-<?php echo e($project->uid); ?>" id="modal-delete-project-button-<?php echo e($project->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-'.e($project->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete_project'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-approve-project-container-'.e($project->uid).'','target' => 'modal-approve-project-button-'.e($project->uid).'','uid' => 'modal_approve_project_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_approve_project')); ?> <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('content', null, []); ?> 
                                ...
                                <a href="<?php echo e(url('project/' . $project->pid . '/' . $project->slug)); ?>" target="_blank" class="text-zinc-700 hover:text-primary-600 font-semibold text-[13px] block"><?php echo e($project->title); ?></a>
                             <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="approve('<?php echo e($project->id); ?>')"
                                        ...
                                        <div wire:loading wire:target="approve('<?php echo e($project->id); ?>')">
                                        ...
                                        <div wire:loading.remove wire:target="approve('<?php echo e($project->id); ?>')">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-reject-project-container-'.e($project->uid).'','target' => 'modal-reject-project-button-'.e($project->uid).'','uid' => 'modal_reject_project_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_reject_project')); ?> <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="reject('<?php echo e($project->id); ?>')"
                                        wire:loading.attr="disabled"
                                        ...
                                        <div wire:loading wire:target="reject('<?php echo e($project->id); ?>')">
                                            <svg role="status" class="inline w-4 h-4 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                                <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                            </svg>
                                        ...
                                        <div wire:loading.remove wire:target="reject('<?php echo e($project->id); ?>')">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-delete-project-container-'.e($project->uid).'','target' => 'modal-delete-project-button-'.e($project->uid).'','uid' => 'modal_delete_project_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_delete_project')); ?> <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        ...
                                        <div wire:loading wire:target="delete('<?php echo e($project->id); ?>')">
                                            <svg role="status" class="inline w-4 h-4 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                                <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                            </svg>
                                        ...
                                        <div wire:loading.remove wire:target="delete('<?php echo e($project->id); ?>')">
            ...
            return {
                ...
                rejection(text) {
                    window.$wireui.notify({
                        title      : "<?php echo e(__('messages.t_rejection_reason')); ?>",
                        description: text,
                        icon       : 'error'
                    })
                }
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/projects/projects.blade.php ENDPATH**/ ?>