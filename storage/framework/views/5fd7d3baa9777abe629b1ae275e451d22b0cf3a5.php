<?php if($paginator->hasPages()): ?>
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between w-full">
        ...
        <div class="hidden md:flex-1 md:flex md:items-center md:justify-center">
            ...
            <div>
                <span class="relative z-0 flex space-x-1 rtl:space-x-reverse">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" class="relative inline-flex items-center justify-center text-xs font-medium w-8 h-8 leading-8 text-center border border-gray-100 dark:border-zinc-600 dark:hover:border-zinc-500 rounded-full" aria-label="<?php echo e(__('pagination.previous')); ?>">
                    ...
                    <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(is_string($element)): ?>
                            <span aria-disabled="true">
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 dark:text-gray-300 bg-white border border-gray-300 cursor-default leading-5"><?php echo e($element); ?></span>
                            </span>
                        <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($page == $paginator->currentPage()): ?>
                                    <span aria-current="page">
                                        <span class="block w-8 h-8 leading-8 text-center text-white bg-primary-600 border-primary-600 rounded-full text-xs font-medium"><?php echo e($page); ?></span>
                                    </span>
                                <?php else: ?>
                                    <a href="<?php echo e($url); ?>" class="block w-8 h-8 leading-8 text-center border border-gray-100 dark:border-zinc-600 dark:hover:border-zinc-500 dark:text-gray-300 rounded-full text-xs font-medium" aria-label="<?php echo e(__('Go to page :page', ['page' => $page])); ?>">
                                        <?php echo e($page); ?>
                    ...
                    <?php if($paginator->hasMorePages()): ?>
                        <a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" class="relative inline-flex items-center justify-center text-xs font-medium w-8 h-8 leading-8 text-center border border-gray-100 dark:border-zinc-600 dark:hover:border-zinc-500 rounded-full" aria-label="<?php echo e(__('pagination.next')); ?>">
...
<?php endif; ?>
<?php /**PATH /var/www/html/riverr/resources/views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>