<div class="w-full relative">
    ...
    <div class="relative bg-white dark:bg-zinc-800 shadow rounded-lg px-4 py-5 sm:px-6 mt-6 <?php echo e($view_data['bid']['is_highlight'] ? 'ltr:border-l-8 rtl:border-l-8 border-amber-300' : ''); ?>">
        ...
        <div class="sm:flex items-center justify-between mb-8">
            ...
            <div class="flex items-center sm:space-x-4 rtl:space-x-reverse">
                  ...
                  <a href="<?php echo e(url('profile', $view_data['freelancer']['username'])); ?>" class="hidden sm:block">
                    <img class="rounded-full h-12 w-12 object-cover object-center lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e($view_data['freelancer']['avatar']); ?>" alt="<?php echo e($view_data['freelancer']['username']); ?>">
                </a>
                    ...
                    <div class="flex items-center">
                        ...
                        <?php if($view_data['freelancer']['fullname']): ?>
                            <span class="font-medium text-zinc-900 text-sm hover:text-black ltr:pr-1 rtl:pl-1 dark:text-zinc-300 dark:hover:text-white">
                                <?php echo e($view_data['freelancer']['fullname']); ?>

                            </span>
                        <?php endif; ?>
    
                        
                        <a href="<?php echo e(url('profile', $view_data['freelancer']['username'])); ?>" class="font-medium text-gray-500 text-[13px] hover:text-primary-600 focus:text-primary-600 inline-flex items-center dark:text-zinc-400">
                            ...
                            <span><?php echo e($view_data['freelancer']['username']); ?></span>
                        </a>
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px]">
                        ...
                        <?php if($view_data['freelancer']['country']): ?>
                            <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(countryFlag($view_data['freelancer']['country']['code'])); ?>" alt="<?php echo e($view_data['freelancer']['country']['name']); ?>">
                                <span class="dark:text-zinc-300 hidden sm:block"><?php echo e($view_data['freelancer']['country']['name']); ?></span>
                            </p>
                        ...
                        <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                            <svg aria-hidden="true" class="w-4 h-4 <?php echo e($view_data['freelancer']['rating'] == 0 ? 'text-gray-400' : 'text-amber-500'); ?> -mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                            <span class="dark:text-zinc-300">
                                <?php echo e($view_data['freelancer']['rating']); ?>
                        ...
                        <span class="flex items-center text-sm font-normal text-gray-500 bg-gray-100 dark:bg-zinc-700 dark:text-zinc-400 px-3 py-2 rounded-sm justify-center">
                            ...
                            <div>
                                <?php if($view_data['bid']['days'] === 1): ?>
                                    <?php echo e($view_data['bid']['days']); ?> <?php echo e(strtolower(__('messages.t_day'))); ?>

                                <?php else: ?>
                                    <?php echo e($view_data['bid']['days']); ?> <?php echo e(strtolower(__('messages.t_days'))); ?>
        ...
        <?php if($view_data['bid']['message']): ?>
            ...
            <div class="mb-2 font-normal text-sm leading-relaxed text-gray-500 dark:text-gray-300">
                <?php if(strlen($view_data['bid']['message']) > 220): ?>
                    <div class="break-all">

                        
                        <span id="bid-card-message-short-<?php echo e($view_data['bid']['id']); ?>">
                            <?php echo e(add_3_dots(htmlspecialchars_decode($view_data['bid']['message']), 220, null)); ?>

                        </span>

                        
                        <span id="bid-card-message-long-<?php echo e($view_data['bid']['id']); ?>" class="hidden">
                            <?php echo nl2br(htmlspecialchars_decode($view_data['bid']['message'])); ?>

                        </span>

                        
                        <span class="whitespace-nowrap before:content-['['] after:content-[']'] before:px-1 after:px-1 text-sm font-semibold text-blue-600 hover:underline cursor-pointer hover:text-blue-500" id="bid-card-message-more-less-button-<?php echo e($view_data['bid']['id']); ?>"><?php echo app('translator')->get('messages.t_more'); ?></span>
                            
                    </div>
                    <script>
                        const target_btn   = document.getElementById("bid-card-message-more-less-button-<?php echo e($view_data['bid']['id']); ?>");
                        const target_short = document.getElementById("bid-card-message-short-<?php echo e($view_data['bid']['id']); ?>");
                        const target_long  = document.getElementById("bid-card-message-long-<?php echo e($view_data['bid']['id']); ?>");
                        target_btn.onclick = function() {
                            if (target_long.classList.contains('hidden')) {
                                ...
                                target_btn.innerHTML = "<?php echo e(__('messages.t_less')); ?>";
                            } else {
                                target_short.classList.remove('hidden');
                                target_long.classList.add('hidden');
                                target_btn.innerHTML = "<?php echo e(__('messages.t_more')); ?>";
                            }
                        }
                    </script>
                <?php else: ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->uid === $view_data['project']['employer_id']): ?>
                        ...
                        <?php if($this->view_data['freelancer']['chat']): ?>
                            <a href="<?php echo e(url('messages/new', $view_data['freelancer']['username'])); ?>" class="inline-flex items-center rounded border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-gray-600 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-opacity-50 focus:ring-zinc-300 focus:ring-offset-2 focus:ring-offset-zinc-100 space-x-1 rtl:space-x-reverse dark:shadow-none dark:bg-zinc-700 dark:border-zinc-800 dark:hover:bg-zinc-700/40 dark:text-zinc-300 dark:hover:text-gray-100 dark:ring-offset-zinc-500">
            ...
            <aside class="flex items-center mt-3 space-x-5 rtl:space-x-reverse text-xs text-gray-500 dark:text-zinc-300">
                ...
                <?php if($view_data['bid']['is_sponsored']): ?>
                    <div class="flex items-center space-x-1 rtl:space-x-reverse">
                        ...
                        <span><?php echo e(__('messages.t_sponsored')); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <div class="flex items-center space-x-1 rtl:space-x-reverse">
                    ...
                    <span><?php echo e(format_date($view_data['bid']['date'], 'ago')); ?></span>
                </div>
    
                
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->id() != $view_data['freelancer']['id']): ?>
                        <div class="flex items-center space-x-1 rtl:space-x-reverse hover:underline cursor-pointer" id="modal-report-bid-button-<?php echo e($bid_id); ?>">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->id() == $view_data['freelancer']['id'] && !$view_data['bid']['is_awarded'] && $view_data['project']['status'] === 'active'): ?>
                        <a href="<?php echo e(url('seller/projects/bids/edit', $bid_id)); ?>" class="flex items-center space-x-1 rtl:space-x-reverse hover:underline cursor-pointer">
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-report-bid-container-'.e($bid_id).'','target' => 'modal-report-bid-button-'.e($bid_id).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-xl']); ?>
            
                
                 <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_what_is_wrong_with_this_bid')); ?> <?php $__env->endSlot(); ?>
                        ...
                        <div class="col-span-12">
                            <fieldset class="w-full">
                                <div class="space-y-4">
                                    ...
                                    <?php for($i = 1; $i <= 4; $i++): ?>
                                        <div class="flex items-center">
                                            <input wire:model.defer="report_reason" value="reason_<?php echo e($i); ?>" id="report_bid_<?php echo e($bid_id); ?>_reason_<?php echo e($i); ?>" name="report_reason" type="radio" class="focus:ring-primary-600 h-4 w-4 text-primary-700 border-gray-300 dark:bg-transparent dark:border-zinc-600 dark:focus:ring-offset-zinc-500 dark:focus:ring-zinc-500 dark:text-zinc-600">
                                            <label for="report_bid_<?php echo e($bid_id); ?>_reason_<?php echo e($i); ?>" class="ltr:ml-3 rtl:mr-3 block text-sm font-medium text-gray-700 dark:text-zinc-200"> 
                                                <?php echo e(__('messages.t_report_bid_reason_' . $i)); ?>  
                                            </label>
                                        </div>
                                    <?php endfor; ?>
    ...
    <?php if($view_data['bid']['is_awarded']): ?>
        <script>
            document.addEventListener('update-awarded-bid-card', (e) => {
                ...
                // Get bid id
                const bid_id         = "<?php echo e($view_data['bid']['id']); ?>";
                ...
                if (bid_id === awarded_bid_id) {
                    window.livewire.find('<?php echo e($_instance->id); ?>').updateBid();
                }
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/cards/bid.blade.php ENDPATH**/ ?>