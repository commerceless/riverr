<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_edit_article')); ?></h2>
            </div>
...
<?php endif; ?>
                    ...
                    <?php if($article->image): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $article->image )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'update','text' => ''.e(__('messages.t_update')).'','block' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'id' => 'edit-blog-article-btn']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div>    <?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/blog/options/edit.blade.php ENDPATH**/ ?>