<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_offline_payment')); ?></h2>
                <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.t_setup_alternative_payment_offline')); ?></p>
            </div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_offline_payment')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_enable_offline_payments')),'model' => 'is_enabled','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_details')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_enter_payment_method_details')),'model' => 'details','icon' => 'text-box-edit-outline','rows' => 8]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php if(settings('offline_payment')->logo): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( settings('offline_payment')->logo )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/services/offline.blade.php ENDPATH**/ ?>