        ...
        <div class="w-full mb-0 md:mb-12">
            ...
            <div class="md:flex items-center justify-between mb-0 md:mb-6">
                ...
                <div class="hidden items-center md:!grid">
                    <span class="uppercase text-[10px] text-gray-400 dark:text-gray-300 mb-1 tracking-widest"><?php echo e(__('messages.t_starting_at')); ?></span>
                        ...
                        <section id="main-carousel" class="splide rounded-xl">
                            <div class="splide__track">
                                    <ul class="splide__list">
                                        ...
                                        <?php if($gig->video_id): ?>
                                            <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain" data-splide-youtube="https://www.youtube.com/watch?v=<?php echo e($gig->video_id); ?>">
                                                <img src="<?php echo e(src($gig->imageLarge)); ?>" alt="<?php echo e($gig->title); ?>" class=" object-contain">
                                            </li>
                                        <?php endif; ?>

                                         <?php if($gig->vimeo_video_id): ?>
                                            <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain" data-splide-vimeo="https://player.vimeo.com/video<?php echo e($gig->vimeo_video_id); ?>">
                                                <img src="<?php echo e(src($gig->imageLarge)); ?>" alt="<?php echo e($gig->title); ?>" class=" object-contain">
                                            </li>
                                        <?php endif; ?> 
                                        ...
                                        <?php $__currentLoopData = $gig->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain">
                                                <img src="<?php echo e(src($image->large)); ?>" alt="<?php echo e($gig->title); ?>" class="object-contain ">
                                            </li>
                        ...
                        <section id="thumbnail-carousel" class="splide">
                            <div class="splide__track">
                                    <ul class="splide__list">
                                        ...
                                        <?php if($gig->vimeovideo_link): ?>
                                            <li class="splide__slide !sr-only" data-splide-vimeo="<?php echo e($gig->vimeo_video_link); ?>">
                                                <img src="<?php echo e(src($gig->thumbnail)); ?>" alt="<?php echo e($gig->title); ?>" class=" object-cover">
                                            </li>
                                        <?php endif; ?>
            ...
            <div class="max-w-2xl mx-auto mt-6 md:mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                ...
                <div class="flex flex-col-reverse">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="w-full mt-4 grid md:!flex justify-between items-center border-b border-gray-50 dark:border-zinc-700 pb-9 space-y-3 md:space-y-0 space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                <?php if($gig->orders_in_queue == 1 || $gig->orders_in_queue == 0): ?>
                                    <?php echo e(__('messages.t_number_order_in_queue', ['number' => $gig->orders_in_queue])); ?>
                    ...
                    <div class="flex items-center">
                        <div class="flex items-center" wire:ignore>
                            ...
                            <?php if($gig->rating == 0): ?>
                                <div class="text-[13px] font-black  text-gray-500 ltr:ml-2 rtl:mr-2"><?php echo e(__('messages.t_n_a')); ?></div>
                            <?php else: ?>
                                <div class="text-[13px] font-black  text-amber-500 ltr:ml-2 rtl:mr-2"><?php echo e($gig->rating); ?></div>
                            <?php endif; ?>
                ...
                <?php if($gig->upgrades()->count()): ?>
                    <div class="mt-6">
                        <?php $__currentLoopData = $gig->upgrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $upgrade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="relative block py-4 cursor-pointer sm:flex sm:justify-between focus:outline-none bg-transparent" wire:key="add-to-cart-upgrades-<?php echo e($key); ?>">
                                <div class="flex items-center">
                                    <input type="checkbox" value="<?php echo e($upgrade->uid); ?>" wire:model.defer="upgrades" class="w-4 h-4 text-primary-600 bg-transparent cursor-pointer rounded-sm ltr:mr-4 rtl:ml-4 border-2 border-gray-300 focus:ring-primary-600">
                                    <div class="text-sm">
                                        <p id="server-size-0-label" class="font-medium text-gray-600 dark:text-gray-300 text-sm"><?php echo e($upgrade->title); ?></p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                    ...
                    <button 
                        ...
                        <div wire:loading.remove wire:target="addToCart">
                            <?php echo e(__('messages.t_add_to_cart')); ?>

                        </div>
                    </button>

                    
                    <a href="<?php echo e(url('messages/new', $gig->owner->username)); ?>" target="_blank" class="w-full bg-primary-100 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-[13px] font-medium text-primary-600 hover:bg-primary-200 focus:outline-none"><?php echo e(__('messages.t_contact_seller')); ?></a>
                ...
                <?php if($gig->documents()->count()): ?>
                    <div class="border-t border-gray-200 dark:border-zinc-700 mt-10 pt-10">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('messages.t_documents')); ?></h3>
                ...
                <div class="border-t border-gray-200 dark:border-zinc-700 mt-10 pt-10">
                    <h3 class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('messages.t_actions')); ?></h3>
                    <div class="mt-4 text-gray-500">
                        <ul role="list" class="flex items-center space-x-6 mt-4 rtl:space-x-reverse">
                            ...
                            <div class="flex items-center group cursor-pointer" id="modals-share-btn">
                                ...
                                <span class="text-sm font-medium text-gray-600 group-hover:text-gray-900 dark:text-gray-300 dark:group-hover:text-gray-200 hidden md:block"><?php echo e(__('messages.t_share')); ?></span>
                            </div>
                            ...
                            <?php endif; ?>
                                ...
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-300 dark:group-hover:text-gray-200 group-hover:text-red-600 hidden md:block"><?php echo e(__('messages.t_report')); ?></span>
                            </div>
                                ...
                                <?php if(auth()->id() !== $gig->user_id): ?>
                                    ...
                                    <?php if($inFavorite): ?>
                                        <div class="flex items-center group cursor-pointer" wire:click="removeFromFavorite">
                                            ...
                                            <span class="text-sm font-medium text-primary-600 hidden md:block"><?php echo e(__('messages.t_remove_from_favorite')); ?></span>
                                        </div>
                                    <?php else: ?>
                                        <div class="flex items-center group cursor-pointer" wire:click="addToFavorite">
                                            ...
                                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300 dark:group-hover:text-gray-200 group-hover:text-primary-600 hidden md:block"><?php echo e(__('messages.t_add_to_favorite')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                ...
                <div x-data="Components.tabs()" @tab-click.window="onTabClick" @tab-keydown.window="onTabKeydown">
                    ...
                    <div id="tab-panel-reviews" class="-mb-10" x-data="Components.tabPanel(0)" aria-labelledby="tab-reviews" x-init="init()" x-show="selected" @tab-select.window="onTabSelect" role="tabpanel" tabindex="0">
                        ...
                        <div class="py-6">
                            <?php $__currentLoopData = $gig->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url('search?q=' . $tag->slug)); ?>" class="mb-3 text-xs font-semibold inline-block py-2 px-4 rounded text-slate-600 dark:text-zinc-400 bg-gray-100 dark:bg-zinc-700 dark:hover:bg-zinc-600 hover:bg-gray-200 last:mr-0 ltr:mr-1 rtl:ml-1">
                                    <?php echo e($tag->name); ?>
                    ...
                    <div id="tab-panel-license" class="pt-10" x-data="Components.tabPanel(0)" aria-labelledby="tab-license" x-init="init()" x-show="selected" @tab-select.window="onTabSelect" role="tabpanel" tabindex="0" style="display: none;">
                                        ...
                                        <div class="py-6">
                                            <div class="flex items-center">
                                                <a href="<?php echo e(url('profile', $review->user->username)); ?>" target="_blank">
                                                    <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($review->user->avatar)); ?>" alt="<?php echo e($review->user->username); ?>" class="lazy h-8 w-8 rounded-full">
                                                </a>
                                                <div class="ltr:ml-4 rtl:mr-4 group">
                                                    <a href="<?php echo e(url('profile', $review->user->username)); ?>" target="_blank" class="text-sm font-bold text-gray-900 dark:text-gray-200 flex items-center group-hover:text-primary-600">
                                                        <?php echo e($review->user->username); ?>

                                                        <?php if($review->user->status === 'verified'): ?>
                                                            <img data-tooltip-target="account-verified-badge-<?php echo e($review->uid); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('public/img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
                                                            <div id="account-verified-badge-<?php echo e($review->uid); ?>" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                <?php echo e(__('messages.t_account_verified')); ?>
                                                        ...
                                                        <?php if($review->user->country): ?>
                                                            <div class="ltr:ml-2 rtl:mr-2">
                                                                <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(countryFlag($review->user->country?->code)); ?>" alt="<?php echo e($review->user->country?->name); ?>" class="lazy h-4 -mt-px rounded-sm">
                                                            </div>
                                                        <?php endif; ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center block text-sm font-normal text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_no_data_to_show_now')); ?></div>
        ...
        <div class="mt-12 sm:mt-24" wire:ignore>
            ...
            <div class="flex justify-between mb-6">
                ...
                <div class="ltr:border-l-8 rtl:border-r-8 border-primary-600 ltr:pl-4 rtl:pr-4">
                    <span class="font-extrabold text-base text-gray-900 dark:text-gray-100 pb-1 tracking-wide block"><?php echo e(__('messages.t_you_may_also_like')); ?></span>
                    <p class="text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_u_may_also_like_the_following_gigs')); ?></p>
                </div>
            ...
            return {
                ...
                youCantReport() {
                    window.$wireui.notify({
                        ...
                        description: "<?php echo e(__('messages.t_u_cant_report_this_gig')); ?>",
                        icon       : 'info'
                    });
                },
                ...
                loginToReport() {
                    window.$wireui.notify({
                        title      : "<?php echo e(__('messages.t_info')); ?>",
                        description: "<?php echo e(__('messages.t_pls_login_or_register_to_report_this_gig')); ?>",
                        icon       : 'info'
                    });
                },
...
<?php $__env->startPush('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(url('public/css/ckeditor-inline.css')); ?>">

    
    <link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css"/>

<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>