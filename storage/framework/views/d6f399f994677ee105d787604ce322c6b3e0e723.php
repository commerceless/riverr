...
<?php endif; ?>
    ...
    <main class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-2 bg-transparent py-2 ltr:pr-6 rtl:pl-6 ltr:border-l-8 rtl:border-r-8 ltr:pl-4 rtl:pr-4 border-primary-600 rounded">
            ...
            <div>
                <span class="font-extrabold text-base text-gray-800 dark:text-gray-100 pb-1 block tracking-wider"><?php echo e($subcategory->name); ?></span>
                <p class="text-sm text-gray-400"><?php echo e($subcategory->description); ?></p>
            </div>
                ...
                <div class="lg:col-span-2 xl:col-span-3">
                    <div class="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="col-span-12 lg:col-span-6 xl:col-span-4 md:col-span-6 sm:col-span-6" wire:key="gigs-list-<?php echo e($gig->uid); ?>">
                                <?php
if (! isset($_instance)) {
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/categories/subcategory.blade.php ENDPATH**/ ?>