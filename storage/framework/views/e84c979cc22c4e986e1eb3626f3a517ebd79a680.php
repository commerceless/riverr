	...
	<div class="relative max-w-6xl mx-auto">
		<div class="text-center">
			<h2 class="text-3xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-4xl">
                <?php echo e(__('messages.t_blog')); ?>    
            </h2>
			<p class="mt-3 max-w-2xl mx-auto text-base text-gray-500 dark:text-gray-300 sm:mt-4">
                <?php echo e(__('messages.t_latest_appname_news', ['app_name' => config('app.name')])); ?>
		...
		<div class="mt-12 max-w-lg mx-auto grid gap-8 lg:grid-cols-4 lg:max-w-none">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex flex-col rounded-lg shadow-sm overflow-hidden">
                    <a href="<?php echo e(url('blog', $article->slug)); ?>" class="flex-shrink-0">
                        <img class="h-48 w-full object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($article->image)); ?>" alt="<?php echo e($article->title); ?>">
                    </a>
                    <div class="flex-1 bg-white dark:bg-zinc-800 p-6 flex flex-col justify-between">
                        <div class="flex-1">
                            <p class="text-xs font-medium text-gray-400">
                                <?php echo e(__('messages.t_x_min_read', ['x' => $article->reading_time])); ?>

                            </p>
                            <a href="<?php echo e(url('blog', $article->slug)); ?>" class="block mt-2 truncate overflow-hidden" style="text-overflow: ellipsis;">
                                <p class="text-base font-semibold text-gray-900 dark:text-gray-200 hover:text-primary-600 truncate"><?php echo e($article->title); ?></p>
                            </a>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/blog/blog.blade.php ENDPATH**/ ?>