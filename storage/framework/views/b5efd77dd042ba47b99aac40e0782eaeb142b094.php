<div class="w-full">
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol role="list" class="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div>
                    <a href="<?php echo e(url('/')); ?>" class="text-gray-400 hover:text-gray-500 dark:text-zinc-300 dark:hover:text-zinc-100">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(url('explore/projects')); ?>" class="ltr:ml-2 rtl:mr-2 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-zinc-300 dark:hover:text-zinc-100">
    ...
    <p class="text-sm text-zinc-500 font-normal tracking-wide dark:text-zinc-400"><?php echo e($category->seo_description); ?></p>

    
    <div class="mt-4">
        <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(url('explore/projects/' . $category->slug . '/' . $skill->slug)); ?>" class="bg-primary-100/50 hover:bg-primary-200 text-primary-800 text-xs font-semibold ltr:mr-2 rtl:ml-2 px-2.5 py-0.5 rounded border border-primary-400 dark:bg-transparent dark:border-zinc-600 dark:text-zinc-400 dark:hover:bg-zinc-700 dark:hover:text-zinc-100" wire:key="explore-projects-category-skill-<?php echo e($skill->uid); ?>">
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/explore/projects/category.blade.php ENDPATH**/ ?>