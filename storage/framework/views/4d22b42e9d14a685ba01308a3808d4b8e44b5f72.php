        ...
        <div class="sm:flex items-center justify-between">
            ...
            <div class="space-x-3 rtl:space-x-reverse">
                ...
                <a href="<?php echo e(admin_url('users/create')); ?>" class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded border font-semibold focus:outline-none px-3 py-3 leading-5 text-[13px] border-primary-600 bg-primary-600 text-white hover:text-white hover:bg-primary-700 hover:border-primary-700 focus:ring focus:ring-primary-500 focus:ring-opacity-50 active:bg-primary-700 active:border-primary-700">
                    ...
                    <span><?php echo e(__('messages.t_create_user')); ?></span>
                </a>
        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800 dark:text-white ">
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_earnings')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_registeration_date')); ?></th>
                    ...
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="users-<?php echo e($user->id); ?>">
                        ...
                        <td class="ltr:pl-4 rtl:pr-4">
                            <a href="<?php echo e(url('profile', $user->username)); ?>" target="_blank" class="flex items-center">
                                <div class="w-8 h-8">
                                    <img class="w-full h-full rounded object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($user->avatar)); ?>" alt="<?php echo e($user->username); ?>" />
                                </div>
                        ...
                        <td class="text-center">
                            <?php if($user->account_type === 'seller'): ?>
                                <span class="text-xs font-bold tracking-wide text-primary-600"><?php echo e(__('messages.t_seller')); ?></span>
                            <?php else: ?>
                        ...
                        <td class="text-center">
                            <div class="relative inline-block text-left">
                                <div>
                                    <button data-dropdown-toggle="table-options-dropdown-<?php echo e($user->id); ?>" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                ...
                                <div id="table-options-dropdown-<?php echo e($user->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">
                                        ...
                                        <?php if($user->status === 'pending'): ?>
                                            <button wire:key="option-activate-<?php echo e($user->id); ?>" wire:click="activate('<?php echo e($user->id); ?>')" wire:loading.attr="disabled" wire:target="activate('<?php echo e($user->id); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
                                        ...
                                        <?php if($user->status !== 'banned'): ?>
                                            <button wire:key="option-ban-<?php echo e($user->id); ?>" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_ban_this_user')); ?>') ? $wire.ban('<?php echo e($user->id); ?>') : ''" wire:loading.attr="disabled" wire:target="ban('<?php echo e($user->id); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
                                        ...
                                        <button wire:key="option-delete-<?php echo e($user->id); ?>" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this_user')); ?>') ? $wire.delete('<?php echo e($user->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($user->id); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
...
<?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/users/users.blade.php ENDPATH**/ ?>