        ...
        <div class="col-span-12 mb-10">
            <div class="md:flex md:items-center md:justify-between ltr:border-l-8 border-primary-600 ltr:pl-4 rtl:border-r-8 rtl:pr-4">
                <div class="flex-1 min-w-0">
                    <h2 class="text-sm font-extrabold text-gray-900 tracking-wider pb-1"><?php echo e(__('messages.t_requirements')); ?></h2>
                    <p class="text-gray-500 font-medium text-xs"><?php echo e(__('messages.t_set_required_info_to_get_from_buyer')); ?></p>
                </div>
                <div class="mt-4 flex md:mt-0 ltr:md:ml-4 rtl:md:mr-4">

                    
                    <a href="<?php echo e(admin_url('gigs')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-xs font-medium text-gray-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600">
                    ...
                    <a href="<?php echo e(url('service', $gig->slug)); ?>" target="_blank" class="ltr:ml-3 rtl:mr-3 inline-flex items-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600">
        ...
        <div class="col-span-12">
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 px-8 py-6 mb-6">
                ...
                <div class="mb-14 flex items-center justify-between">
                    <div>
                        <h2 class="text-sm tracking-wider leading-6 font-black text-gray-900"><?php echo e(__('messages.t_requirements')); ?></h2>
                        <p class="text-xs text-gray-500"><?php echo e(__('messages.t_create_gig_requirements_subtitle')); ?></p>
                    </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-add-service-requirement-container','target' => 'modal-add-service-requirement-button','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'w-2/5']); ?>

        
         <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_add_question')); ?> <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="<?php echo e(isset($add_requirement['type']) && $add_requirement['type'] === 'choice' ? 'col-span-6' : 'col-span-12'); ?>">
                    <div class="relative default-select2 <?php echo e($errors->first('add_requirement.type') ? 'select2-custom-has-error' : ''); ?>">
                    
                        <select data-pharaonic="select2" data-component-id="<?php echo e($this->id); ?>" wire:model="add_requirement.type" id="select2-id-add_requirement.type" data-placeholder="<?php echo e(__('messages.t_get_it_from')); ?>" data-search-off class="select2_requirements">
                            <option value=""></option>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_multiple_choices')).' ','model' => 'add_requirement.is_multiple','hidelabel' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <div class="flex justify-between w-full">
                ...
                <div class="flex items-center">
                    ...
                    <label for="add-requirement-is-required-checkbox" class="ltr:ml-2 rtl:mr-2 text-xs font-medium text-gray-700"><?php echo e(__('messages.t_required')); ?></label>
                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/gigs/options/steps/requirements.blade.php ENDPATH**/ ?>