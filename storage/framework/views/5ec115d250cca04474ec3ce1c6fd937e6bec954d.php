<div class="w-full bg-white shadow rounded-lg" x-data="window.fweXqTeRXrFVxql">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_maintenance_mode')); ?></h2>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/system/maintenance.blade.php ENDPATH**/ ?>