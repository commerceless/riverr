    ...
    <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
        ...
        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4 rounded-t-md">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                ...
                <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_overview')); ?></h3>
                <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_create_gig_overview_subtitle')); ?></p>
                </div>
...
<?php endif; ?>
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <div class="min-w-0">
                    <ul class="max-h-52 flex-auto space-y-1 overflow-y-auto border-2 rounded <?php echo e($errors->first('category') ? 'border-red-500' : 'border-gray-100 dark:border-zinc-700'); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <div class="min-w-0">
                    <ul class="max-h-52 flex-auto space-y-1 overflow-y-auto <?php echo e(count($subcategories) ? 'border-2 rounded' : ''); ?> <?php echo e($errors->first('subcategory') ? 'border-red-500' : 'border-gray-100 dark:border-zinc-700'); ?>">
...
<?php endif; ?>
    ...
    <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
        ...
        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4" :class="seo.is_enabled ? 'rounded-t-md' : 'rounded-md'">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_seo')); ?></h3>
                <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_search_engine_gig_preview')); ?></p>
                </div>
                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
...
<?php endif; ?>
    ...
    <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
        ...
        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4 <?php echo e(count($faqs) ? 'rounded-t-md' : 'rounded-md'); ?>">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                    <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_faq')); ?></h3>
                    <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_create_gig_faq_subtitle')); ?></p>
                </div>
                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'save','text' => ''.e(__('messages.t_save_and_continue')).'','id' => 'create-gig-action-btn']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/create/steps/overview.blade.php ENDPATH**/ ?>