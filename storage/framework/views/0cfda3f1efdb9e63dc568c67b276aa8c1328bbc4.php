<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(config()->get('direction')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => current_theme() === 'dark', 'h-full']) ?>">
	<head>
		<meta charset="UTF-8">
			...
			<div x-show="open" class="fixed inset-0 flex z-40 md:hidden" x-ref="dialog" aria-modal="true" style="display: none">
				...
				class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white dark:bg-zinc-800">
					...
					<?php if(current_theme() === 'dark' && settings('general')->logo_dark): ?>
						<a href="<?php echo e(url('/')); ?>" class="flex items-center flex-shrink-0 px-5">
				...
				<div class="flex-shrink-0 flex h-16 bg-white dark:bg-zinc-800 border-b border-[#e9eef5] dark:border-zinc-600">
					...
					<div class="flex-1 px-4 md:px-6 flex justify-between">
						...
						<div class="ltr:ml-4 rtl:mr-4 flex items-center md:ltr:ml-6 md:rtl:mr-6">
							...
							?>
							<a href="<?php echo e(url('inbox')); ?>" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative mx-4 dark:text-gray-100 dark:hover:text-white">
							...
							<div x-data="Components.menu({ open: false })" x-init="init()" @keydown.escape.stop="open = false; focusButton()" @click.away="onClickAway($event)" class="relative ltr:ml-3 rtl:mr-3">
								...
								<div>
									<button 
										...
										<img class="h-8 w-8 rounded-full object-cover object-center" src="<?php echo e(src(auth()->user()->avatar)); ?>" alt="<?php echo e(auth()->user()->username); ?>">
...
} elseif ($_instance->childHasBeenRendered('BmM31VZ')) {
    $componentId = $_instance->getRenderedChildComponentId('BmM31VZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('BmM31VZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BmM31VZ');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('BmM31VZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/riverr/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
        ...
        <script src="<?php echo e(url('public/js/components.js?v=1.3.2')); ?>"></script>
  ...
  <?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>