        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800 dark:text-white ">
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_document_type')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_front_side')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_back_side')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_selfie_photo')); ?></th>
            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $verifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="verifications-<?php echo e($v->id); ?>">

                        
                        <td class="ltr:pl-4 rtl:pr-4">
                            <a href="<?php echo e(url('profile', $v->user->username)); ?>" target="_blank" class="flex items-center">
                                <div class="w-8 h-8">
                                    <img class="w-full h-full rounded object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($v->user->avatar)); ?>" alt="<?php echo e($v->user->username); ?>" />
                                </div>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(url( 'uploads/verifications/' . $v->uid . '/front/' . $v->file_front_side )); ?>" target="_blank">
                                <img class="w-8 h-8 rounded object-cover mx-auto lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($v->frontside)); ?>" />
                            </a>
                        </td>
                        ...
                        <td class="text-center">
                            <?php if($v->backside): ?>
                                <a href="<?php echo e(url( 'uploads/verifications/' . $v->uid . '/back/' . $v->file_back_side )); ?>" target="_blank">
                                    <img class="w-8 h-8 rounded object-cover mx-auto lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($v->backside)); ?>" />
                                </a>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(url( 'uploads/verifications/' . $v->uid . '/selfie/' . $v->file_selfie )); ?>" target="_blank">
                                <img class="w-8 h-8 rounded object-cover mx-auto lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($v->selfie)); ?>" />
                            </a>
                        </td>
                        ...
                        <td class="text-center">
                            <?php if($v->status === 'pending'): ?>
                                <div class="relative inline-block text-left">
                                    <div>
                                        <button data-dropdown-toggle="table-options-dropdown-<?php echo e($v->id); ?>" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                    ...
                                    <div id="table-options-dropdown-<?php echo e($v->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                        <div class="py-1" role="none">
                                            ...
                                            <button wire:key="option-decline-<?php echo e($v->id); ?>" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_decline_this_verification')); ?>') ? $wire.decline('<?php echo e($v->id); ?>') : ''" wire:loading.attr="disabled" wire:target="decline('<?php echo e($v->id); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
...
<?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/verifications/verifications.blade.php ENDPATH**/ ?>