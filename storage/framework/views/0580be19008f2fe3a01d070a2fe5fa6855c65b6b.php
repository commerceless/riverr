            ...
            <table class="min-w-full text-sm align-middle whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50" wire:key="skills-<?php echo e($skill->uid); ?>">

                            
                            <td class="px-7 py-4 ltr:text-left rtl:text-right">
                                <a href="<?php echo e(url('explore/projects', $skill->category->slug)); ?>" target="_blank" class="text-sm font-semibold text-zinc-700 hover:text-primary-600 tracking-wide">
                            ...
                            <td class="p-4 ltr:text-left rtl:text-right">
                                <a href="<?php echo e(url('explore/projects/' . $skill->category->slug . '/' . $skill->slug)); ?>" target="_blank" class="text-sm font-semibold text-zinc-700 hover:text-primary-600 tracking-wide">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <div>
                                        <a href="<?php echo e(admin_url('projects/skills/edit/' . $skill->uid)); ?>" data-tooltip-target="tooltip-actions-edit-<?php echo e($skill->uid); ?>" id="modal-edit-bid-button-<?php echo e($skill->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-edit-'.e($skill->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_edit_skill'))]); ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <button type="button" data-tooltip-target="tooltip-actions-delete-<?php echo e($skill->uid); ?>" id="modal-delete-skill-button-<?php echo e($skill->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-'.e($skill->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete_skill'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-delete-skill-container-'.e($skill->uid).'','target' => 'modal-delete-skill-button-'.e($skill->uid).'','uid' => 'modal_delete_skill_'.e($skill->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_delete_skill')); ?> <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="delete('<?php echo e($skill->id); ?>')"
                                        ...
                                        <div wire:loading wire:target="delete('<?php echo e($skill->id); ?>')">
                                        ...
                                        <div wire:loading.remove wire:target="delete('<?php echo e($skill->id); ?>')">
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/projects/skills/skills.blade.php ENDPATH**/ ?>