...
<?php endif; ?>
                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_orders_history')); ?></h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_orders_history_subtitle')); ?></p>
                        </div>
                        ...
                        <div class="w-full mb-6">
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-md mb-10" wire:key="orders-<?php echo e($order->uid); ?>">
                                    <div class="bg-gray-50 dark:bg-zinc-600 border-b sm:rounded-t-md flex items-center p-4 sm:p-6 sm:grid sm:grid-cols-4 sm:gap-x-6 dark:border-zinc-600">
                                        ...
                                        <dl class="flex-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
                                            ...
                                            <div>
                                                <dt class="font-medium text-gray-900 dark:text-gray-200"><?php echo e(__('messages.t_date_placed')); ?></dt>
                                                <dd class="mt-2 text-gray-500 dark:text-gray-50 text-xs"><?php echo e(format_date($order->placed_at, config('carbon-formats.F_j,_Y_h_:_i_A'))); ?></dd>
                                            </div>

                                            
                                            <div>
                                                <dt class="font-medium text-gray-900 dark:text-gray-200"><?php echo e(__('messages.t_total_amount')); ?></dt>
                                                    ...
                                                    <div class="flex-1 ltr:md:ml-6 rtl:md:mr-6 text-sm">
                                                        <div class="md:flex md:items-center md:justify-between md:space-x-4 rtl:space-x-reverse xl:pb-4">
                                                                ...
                                                                <div class="inline-block md:!flex text-gray-500 dark:text-gray-300 text-xs space-y-4 md:space-y-0 md:space-x-6 lg:space-x-12 rtl:space-x-reverse">
                                                                    ...
                                                                    <span class="flex">
                                                                        <div class="md:text-center">
                                                                            <p class="text-[10px] tracking-widest text-gray-400 dark:text-gray-300 uppercase"><?php echo e(__('messages.t_total')); ?></p>
                                                                    ...
                                                                    <span class="flex">
                                                                        <div class="md:text-center">
                                                                            <p class="text-[10px] tracking-widest text-gray-400 dark:text-gray-300 uppercase"><?php echo e(__('messages.t_quantity')); ?></p>
                                                                            <p class="mt-2 text-[11px] text-gray-600 dark:text-gray-200 font-medium">
                                                                    ...
                                                                    <span class="flex">
                                                                        <div class="md:text-center">
                                                                            <p class="text-[10px] tracking-widest text-gray-400 dark:text-gray-300 uppercase"><?php echo e(__('messages.t_expected_delivery_date')); ?></p>
                                                                            <p class="mt-2 text-[11px] text-gray-600 dark:text-gray-200 font-medium">
                                                                                <?php if($item->expected_delivery_date): ?>
                                                                                    <?php echo e(format_date($item->expected_delivery_date, config('carbon-formats.F_j,_Y_h_:_i_A'))); ?>
                                                                    ...
                                                                    <span class="flex">
                                                                        <div class="md:text-center">
                                                                            <p class="text-[10px] tracking-widest text-gray-400 dark:text-gray-300 uppercase"><?php echo e(__('messages.t_status')); ?></p>
                                                            ...
                                                            <div class="mt-4 flex space-x-3 md:mt-0">
                                                                ...
                                                                <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-actions-dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-48 dark:bg-zinc-800">
                                                                    <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">

                                                                        
                                                                        <li>
                                                                            <a href="<?php echo e(url('messages/new', $item->owner?->username)); ?>" target="_blank" class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-t">
                                                                                ...
                                                                                <span class="text-xs font-medium text-gray-700 dark:text-gray-300"><?php echo e(__('messages.t_contact_seller')); ?></span>
                                                                            </a>
                                                                        </li>
                                                                        ...
                                                                        <?php if($item->refund): ?>
                                                                            ...
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/refunds/details', $item->refund->uid)); ?>" target="_blank" class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                                                    ...
                                                                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300"><?php echo e(__('messages.t_refund_details')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <?php if($can_refund): ?>
                                                                                <li>
                                                                                    <a href="<?php echo e(url('account/refunds/request', $item->uid)); ?>" target="_blank" class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                                                        <svg class="ltr:mr-3 rtl:ml-3 text-gray-500 w-5 h-5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M16 12h2v4h-2z"></path><path d="M20 7V5c0-1.103-.897-2-2-2H5C3.346 3 2 4.346 2 6v12c0 2.201 1.794 3 3 3h15c1.103 0 2-.897 2-2V9c0-1.103-.897-2-2-2zM5 5h13v2H5a1.001 1.001 0 0 1 0-2zm15 14H5.012C4.55 18.988 4 18.805 4 18V8.815c.314.113.647.185 1 .185h15v10z"></path></svg>
                                                                                        <span class="text-xs font-medium text-gray-700 dark:text-gray-300"><?php echo e(__('messages.t_request_refund')); ?></span>
                                                                                    </a>
                                                                                </li>
                                                                            <?php endif; ?>
                                                                        ...
                                                                        <?php if(in_array($item->status, ['proceeded', 'delivered'])): ?>
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/orders/files?orderId=' . $order->uid . '&itemId=' . $item->uid)); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                                                    ...
                                                                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300"><?php echo e(__('messages.t_delivered_work')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        <?php endif; ?>
                                                                        ...
                                                                        <?php if($item->status === 'pending' && $item->order->invoice && $item->order->invoice->status === 'paid'): ?>
                                                                            <li>
                                                                                <button type="button" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_cancel_service')); ?>') ? $wire.cancel('<?php echo e($item->uid); ?>') : ''" wire:loading.attr="disabled" wire:target="cancel('<?php echo e($item->uid); ?>')" class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 w-full">

                                                                                    
                                                                                    <div wire:loading wire:target="cancel('<?php echo e($item->uid); ?>')">
                                                                                    ...
                                                                                    <div wire:loading.remove wire:target="cancel('<?php echo e($item->uid); ?>')">
                                                                                    ...
                                                                                    <span class="text-xs font-medium"><?php echo e(__('messages.t_cancel_service')); ?></span>
                                                                        ...
                                                                        <?php if(($item->status === 'pending' || $item->status === 'proceeded') && $item->order->invoice && $item->order->invoice->status === 'paid'): ?>
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid)); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-b">
                                                                                    ...
                                                                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300"><?php echo e(__('messages.t_send_requirements')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        <?php endif; ?>
                                                                        ...
                                                                        <?php if( $item->status === 'delivered' && $item->is_finished ): ?>
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/reviews/create/' . $item->uid)); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-b">
                                                                                    ...
                                                                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300"><?php echo e(__('messages.t_make_a_review')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        <?php endif; ?>
                                                ...
                                                <div class="mt-6 sm:flex sm:justify-between">
                                                        ...
                                                        <?php if(!$item->gig->requirements()->exists() || !$item->is_requirements_sent): ?>
                                                            <div class="flex items-center">
                                                                ...
                                                                <p class="ltr:ml-2 rtl:mr-2 text-xs font-medium text-amber-600">
                                                                    <?php echo e(__('messages.t_u_have_send_reqs_asap_to_seller')); ?>
                                                    ...
                                                    <div class="mt-6 border-t border-gray-200 pt-4 flex items-center space-x-4 divide-x divide-gray-200 dark:divide-zinc-600 rtl:divide-x-reverse text-sm font-medium sm:mt-0 sm:ltr:ml-4 sm:rtl:mr-4 sm:border-none sm:pt-0 rtl:space-x-reverse">
                                                        ...
                                                        <div class="flex-1 flex justify-center">
                                                            <a href="<?php echo e(url('service', $item->gig->slug)); ?>" target="_blank" class="text-primary-600 whitespace-nowrap hover:text-primary-600"><?php echo e(__('messages.t_view_gig')); ?></a>
                                                        </div>

                                                        
                                                        <?php if(($item->status === 'pending' || $item->status === 'proceeded') && $item->order->invoice && $item->order->invoice->status === 'paid'): ?>
                                                            <div class="flex-1 ltr:pl-4 rtl:pr-4 flex justify-center">
                                                                <a href="<?php echo e(url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid)); ?>" class="text-primary-600 whitespace-nowrap hover:text-primary-600"><?php echo e(__('messages.t_send_requirements')); ?></a>
                                                            </div>
                                                        <?php endif; ?>
                                ...
                                <div class="rounded-md bg-blue-50 p-4">
                                    ...
                                    <div class="ltr:ml-3 rtl:mr-3 flex-1 md:flex md:justify-between">
                                        <p class="text-sm text-blue-700 font-medium">
                                            <?php echo e(__('messages.t_ur_orders_history_is_empty_right_now')); ?>

                                        </p>
                                        <p class="mt-3 text-sm md:mt-0 md:ltr:ml-6 md:rtl:mr-6">
                                            <a href="<?php echo e(url('/')); ?>" class="whitespace-nowrap font-medium text-blue-700 hover:text-blue-600"><?php echo e(__('messages.t_go_shopping')); ?> <span aria-hidden="true">&rarr;</span></a>
                                        </p>
                                    </div>
                                    </div>
                                </div>
...
</main><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/account/orders/orders.blade.php ENDPATH**/ ?>