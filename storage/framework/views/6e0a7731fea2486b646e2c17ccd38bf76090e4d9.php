        ...
        <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 rtl:space-x-reverse sm:mb-0">
            ...
            <li>
                <div class="flex items-center">
                    <a href="<?php echo e(url('/')); ?>" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 ltr:md:ml-2 rtl:md:mr-2 dark:text-zinc-300 dark:hover:text-white">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(url('explore/projects')); ?>" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 ltr:md:ml-2 rtl:md:mr-2 dark:text-zinc-300 dark:hover:text-white">
				...
				<section class="w-full">
					<div class="bg-white dark:bg-zinc-800 shadow-sm rounded-lg border dark:border-transparent">
						...
						<div class="border-t border-gray-100 dark:border-zinc-600 px-4 py-5 sm:px-6 pb-8">
							...
							<h2 class="mb-4 font-bold text-zinc-600 dark:text-zinc-300 text-sm">
								<?php echo e(__('messages.t_client_info')); ?>    
							</h2> 
							<div class="mb-12 block">
								<div class="flex items-center space-x-4 rtl:space-x-reverse">
									<img class="w-10 h-10 rounded-md lazy object-cover" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($project->client->avatar)); ?>" alt="<?php echo e($project->title); ?>">
									<div class="font-medium text-zinc-800 dark:text-white">
										<div class="text-[13px] mb-1"><?php echo e($this->clientUsername()); ?></div>
								...
								<div class="rounded-md bg-yellow-50 dark:bg-zinc-700 p-4 mt-10">
									<div class="flex">
										...
										<div class="ltr:ml-3 rtl:mr-3">
											<h3 class="text-sm font-medium text-yellow-800 dark:text-zinc-100"><?php echo e(__('messages.t_beware_of_scams')); ?></h3>
											<div class="mt-2 text-sm text-yellow-700 dark:text-zinc-300">
												<p>
													<?php echo e(__('messages.t_beware_of_scams_details')); ?>      
												</p>
											</div>
										</div>
									</div>
				...
				<section class="relative">
					...
					<?php if($project->status === 'closed'): ?>
						<div class="bg-white shadow-sm rounded-lg px-6 sm:px-12 py-6 sm:py-12 mt-8 grid text-center items-center justify-center">
							...
							<a href="<?php echo e(url('explore/projects')); ?>" class="text-primary-600 text-[13px] hover:underline font-normal tracking-wide mt-1"><?php echo app('translator')->get('messages.t_find_another_project'); ?></a>
						</div>
					<?php else: ?>
                    ...
                    <div class="border-t border-gray-100 dark:border-zinc-600">
                        <dl>
							...
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								...
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(number_format($project->counter_views)); ?>
							...
							<div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								...
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(number_format($project->counter_impressions)); ?>
							...
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								...
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(format_date($project->created_at, 'ago')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-bid-container','target' => 'modal-bid-button','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-4xl']); ?>
		
				
				 <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_bid_details')); ?> <?php $__env->endSlot(); ?>
					...
					<?php if($bid_current_step === 1): ?>
						<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-2">
							...
							<div class="col-span-12 md:col-span-6">
								...
								<label for="bid-amount-input" class="<?php echo e($errors->first('bid_amount') ? 'text-red-600' : 'text-gray-900'); ?> block mb-2 text-[13px] font-bold dark:text-white">
								...
								<div class="relative w-full">
									...
									<input wire:model.defer="bid_amount" x-on:keyup="calculateProfit" x-on:change="verifyAmount" type="text" id="bid-amount-input" class="<?php echo e($errors->first('bid_amount') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-lg font-medium block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="0.00">
									...
									<div class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center ltr:pr-3 rtl:pl-3 font-bold text-xs tracking-widest dark:text-gray-300 uppercase">
										<?php echo e(settings('currency')->code); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
									<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
										<?php echo e($errors->first('bid_amount')); ?>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-span-12 md:col-span-6">
								...
								<label for="bid-amount-paid-input" class="text-gray-900 mb-2 text-[13px] font-bold dark:text-white flex items-center space-x-2 rtl:space-x-reverse">
									...
									<div id="bid-paid-to-you-tooltip" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
										<?php echo e(__('messages.t_bid_paid_to_you_tooltip')); ?>
							...
							<div class="col-span-12">
								...
								<label for="bid-days-input" class="<?php echo e($errors->first('bid_days') ? 'text-red-600' : 'text-gray-900'); ?> block mb-2 text-[13px] font-bold dark:text-white">
								...
								<div class="relative w-full">
									...
									<input type="text" wire:model.defer="bid_days" id="bid-days-input" class="<?php echo e($errors->first('bid_days') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-lg font-medium block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
...
$message = $__bag->first($__errorArgs[0]); ?>
									<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
										<?php echo e($errors->first('bid_days')); ?>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-span-12">
								...
								<label for="bid-description-input" class="<?php echo e($errors->first('bid_description') ? 'text-red-600' : 'text-gray-900'); ?> block mb-2 text-[13px] font-bold dark:text-white">
								...
								<div class="relative w-full">
									...
									<textarea wire:model.defer="bid_description" id="bid-description-input" class="<?php echo e($errors->first('bid_description') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-lg font-medium block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 placeholder:font-normal" rows="8" placeholder="<?php echo e(__('messages.t_describe_ur_proposal_placeholder')); ?>"></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
									<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
										<?php echo e($errors->first('bid_description')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'next','text' => ''.e(__('messages.t_continue')).'','block' => 0]); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-share-project-container','target' => 'modal-share-project-button','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-md']); ?>
			...
			<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-6">
				...
				<div class="col-span-12">
					<div class="mt-1 relative flex items-center">
					  <input type="text" id="input-project-url-share" value="<?php echo e(url()->current()); ?>" class="shadow-sm focus:ring-primary-600 focus:border-primary-600 block w-full ltr:pr-16 rtl:pl-16 sm:text-[13px] border-gray-200 font-medium rounded-md">
				...
				<div class="col-span-12">
					<ul class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
						...
						<li>
							<a href="https://www.facebook.com/share.php?u=<?php echo e(url()->current()); ?>&t=<?php echo e($project->title); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#3b5998]" data-tooltip-target="share-project-btn-facebook">
							...
							<div id="share-project-btn-facebook" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
								<?php echo e(__('messages.t_share_on_facebook')); ?>
						...
						<li>
							<a href="https://twitter.com/intent/tweet?text=<?php echo e($project->title); ?>%20-%20<?php echo e(url()->current()); ?>%20" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#1DA1F2]" data-tooltip-target="share-project-btn-twitter">
							...
							<div id="share-project-btn-twitter" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
								<?php echo e(__('messages.t_share_on_twitter')); ?>
						...
						<li>
							<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(url()->current()); ?>&title=<?php echo e($project->title); ?>&summary=<?php echo e($project->title); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#0A66C2]" data-tooltip-target="share-project-btn-linkedin">
							...
							<div id="share-project-btn-linkedin" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
								<?php echo e(__('messages.t_share_on_linkedin')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-report-project-container','target' => 'modal-report-project-button','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-xl']); ?>

				
				 <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_report_project')); ?> <?php $__env->endSlot(); ?>
					...
					<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-2">
                        ...
                        <div class="col-span-12">
                            <fieldset class="w-full">
                                <div class="space-y-4">
                                    ...
                                    <?php for($i = 1; $i <= 6; $i++): ?>
                                        <div class="flex items-center">
                                            <input wire:model.defer="report_reason" value="reason_<?php echo e($i); ?>" id="report_project_reason_<?php echo e($i); ?>" name="report_reason" type="radio" class="focus:ring-primary-600 h-4 w-4 text-primary-700 border-gray-300">
                                            <label for="report_project_reason_<?php echo e($i); ?>" class="ltr:ml-3 rtl:mr-3 block text-sm font-medium text-gray-700"> 
                                                <?php echo e(__('messages.t_report_project_reason_' . $i)); ?>  
                                            </label>
                                        </div>
                                    <?php endfor; ?>
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="relative w-full">
                                ...
                                <textarea wire:model.defer="report_description" id="bid-report-description-input" class="<?php echo e($errors->first('report_description') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-lg font-medium block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 placeholder:font-normal" rows="8" placeholder="<?php echo e(__('messages.t_enter_issue_description')); ?>"></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
                                    <?php echo e($errors->first('report_description')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'report','text' => ''.e(__('messages.t_continue')).'','block' => 0]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal49b2fc8ba42c39d638e648b21b88e1b33ae2822c)): ?>
<?php $component = $__componentOriginal49b2fc8ba42c39d638e648b21b88e1b33ae2822c; ?>
		...
		function LVoePqYZdmjQURo() {
			return {
				...
				verifyAmount(e) {
					...
					// Check value
					if (Number(amount) < Number('<?php echo e($project->budget_min); ?>') || Number(amount) > Number('<?php echo e($project->budget_max); ?>')) {
		
						// Error
						window.$wireui.notify({
							title      : "<?php echo e(__('messages.t_error')); ?>",
							description: "<?php echo e(__('messages.t_pls_insert_bid_value_between_budget')); ?>",
							icon       : 'error'
						});
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/project/project.blade.php ENDPATH**/ ?>