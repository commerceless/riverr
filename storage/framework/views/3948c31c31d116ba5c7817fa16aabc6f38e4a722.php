        ...
        <div class="grid grid-cols-12 md:gap-x-6 gap-y-10">
            ...
            <div class="col-span-12 lg:col-span-7">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-gray-200 dark:border-zinc-700 px-8 py-6 mb-8">
                    ...
                    <div class="mb-14">
                        <h2 class="text-base tracking-wide font-bold text-zinc-900 dark:text-gray-100">
                            <?php echo e(__('messages.t_required_info')); ?>
                                        ...
                                        <ul role="list" class="border border-gray-200 dark:border-zinc-700 rounded-md divide-y divide-gray-200 dark:divide-zinc-700">
                                            <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                    <a href="<?php echo e(url('uploads/requirements/' . $item->order->uid . '/' . $item->uid . '/' . $req->id . '/' . $req->form_value['id'])); ?>" target="_blank" class="font-medium text-primary-600 hover:text-primary-500">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-gray-200 dark:border-zinc-700 px-8 py-6">
                    ...
                    <div class="mb-14">
                        <h2 class="text-base tracking-wide font-bold text-zinc-900 dark:text-gray-100">
                            <?php echo e(__('messages.t_order_details')); ?>
                    ...
                    <div class="w-full mb-6">
                        <dl class="divide-y divide-gray-100 dark:divide-zinc-700">
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_posted_date')); ?></dt>
                                <dd class="text-gray-900 dark:text-gray-200 font-bold"><?php echo e(format_date($item->placed_at, 'ago')); ?></dd>
                            </div>

                            
                            <div class="flex justify-between py-3 text-sm font-medium">
                                <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_expected_delivery_date')); ?></dt>
                                <dd class="text-gray-900 dark:text-gray-200 font-bold"><?php echo e(format_date($item->expected_delivery_date, config('carbon-formats.F_j,_Y_h_:_i_A'))); ?></dd>
                            </div>

                            
                            <div class="flex justify-between py-3 text-sm font-medium">
                                <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_profit')); ?></dt>
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                ...
                                <dd class="text-gray-900 dark:text-gray-200 font-bold"><?php echo e($item->quantity); ?></dd>
                            </div>
                    ...
                    <div class="w-full">
                            ...
                            <div class="mb-4">
                                <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_start_this_order_seller')); ?>') ? $wire.progress : ''" wire:target="progress" wire:loading.attr="disabled" type="button" class="px-4 py-4 w-full tracking-wide text-xs bg-indigo-100 outline-none rounded text-primary-700 font-medium active:scale-95 hover:bg-indigo-200 focus:bg-indigo-200 focus:ring-2 focus:ring-indigo-100 focus:ring-offset-2 disabled:bg-gray-400/80 disabled:cursor-not-allowed transition-colors duration-200">
                                    ...
                                    <div wire:loading.remove wire:target="progress">
                                        <?php echo e(__('messages.t_process_the_order')); ?>
                        ...
                        <?php if(in_array($item->status, ['proceeded', 'delivered']) && !$item->is_finished): ?>
                            <div class="">
                                <a href="<?php echo e(url('seller/orders/deliver', $item->uid)); ?>" class="block text-center px-4 py-4 w-full tracking-wide text-xs bg-green-100 outline-none rounded text-green-700 font-medium active:scale-95 hover:bg-green-200 focus:bg-green-200 focus:ring-2 focus:ring-green-100 focus:ring-offset-2 disabled:bg-gray-400/80 disabled:cursor-not-allowed transition-colors duration-200">
            ...
            <div class="col-span-12 lg:col-span-5">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-gray-200 dark:border-zinc-700 px-8 py-6 mb-8">
                    ...
                    <div class="p-2.5">
                        <img class="h-48 w-full rounded-lg object-cover object-center lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($item->gig->thumbnail)); ?>" alt="<?php echo e($item->gig->title); ?>">
                    </div>
                    ...
                    <div class="flex grow flex-col px-4 pb-5 pt-1 text-center sm:px-5">
                        ...
                        <div>
                            <a class="text-[13px] text-gray-400 hover:underline hover:text-gray-600" href="<?php echo e(url('categories/' . $item->gig->category->slug . '/' . $item->gig->subcategory->slug)); ?>" target="_blank">
                                <?php echo e($item->gig->subcategory->name); ?>
                        ...
                        <div class="mt-1">
                                <a href="<?php echo e(url('service', $item->gig->slug)); ?>" target="_blank" class="text-base font-bold text-zinc-700 hover:text-primary-600 focus:text-primary-600 dark:text-zinc-300 dark:hover:text-zinc-100">
                                    <?php echo e($item->gig->title); ?>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-gray-200 dark:border-zinc-700 px-8 py-6 mb-8">
                    ...
                    <div class="mb-14">
                        <h2 class="text-base tracking-wide font-bold text-zinc-900 dark:text-gray-100">
                            <?php echo e(__('messages.t_selected_upgrades')); ?>
                    ...
                    <div class="w-full">
                                ...
                                <?php $__currentLoopData = $item->upgrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upgrade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative flex items-start py-4 first:pt-0 last:pb-0">
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3 text-sm mt-[-3px]">
                                            <label class="font-medium text-gray-600 dark:text-gray-200 text-sm"><?php echo e($upgrade->title); ?></label>
                        ...
                        <?php else: ?>
                            <div class="py-14 px-6 text-center text-sm">
                                ...
                                <p class="mt-4 font-semibold text-gray-900 dark:text-gray-200"><?php echo e(__('messages.t_no_upgrades_selected')); ?></p>
                                <p class="mt-2 text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_buyer_didnt_selected_any_upgrades_or_no_upgrades')); ?></p>
                            </div>
                        <?php endif; ?>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/orders/options/requirements.blade.php ENDPATH**/ ?>