...
} elseif ($_instance->childHasBeenRendered('zA8c6XM')) {
    $componentId = $_instance->getRenderedChildComponentId('zA8c6XM');
    $componentTag = $_instance->getRenderedChildComponentTagName('zA8c6XM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zA8c6XM');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('zA8c6XM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/riverr/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>