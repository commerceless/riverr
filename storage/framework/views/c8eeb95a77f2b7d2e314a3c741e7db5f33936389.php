            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-gray-100 dark:border-zinc-700 px-8 py-6 mb-6">
                ...
                <div class="mb-14 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-[13px] text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_create_gig_pricing_subtitle')); ?></p>
                    </div>
...
<?php endif; ?>
        ...
        <div class="col-span-12 xl:col-span-5">
            <?php $__currentLoopData = $upgrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $upgrade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white dark:bg-zinc-800 dark:border-zinc-700 rounded-lg shadow-sm border border-gray-100 px-8 py-6 mb-6" id="scroll-to-upgrade-id-<?php echo e($key); ?>" wire:key="edit-gig-pricing-upgrade-id-<?php echo e($key); ?>">
                    ...
                    <div class="mb-14 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-[13px] font-medium text-gray-500 dark:text-gray-300"><?php echo e($upgrade['title']); ?></p>
                        </div>
                        <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
...
<?php endif; ?>
                        ...
                        <div class="col-span-12 md:col-span-6" wire:key="<?php echo e(uid()); ?>">
                            <div
                                class="relative default-select2 <?php echo e($errors->first('upgrades.' . $key . '.extra_days') ? 'select2-custom-has-error' : ''); ?>">
                                <label
                                    class="text-[0.8125rem] font-semibold block mb-2 <?php echo e($errors->first('upgrades.' . $key . '.extra_days') ? 'text-red-600 dark:text-red-500' : 'text-gray-700 dark:text-white'); ?>"><?php echo e(__('messages.t_delivery_time')); ?></label>
                                <select
                                    x-data="initSelect2DeliveryTime('select2-id-upgrades-<?php echo e($key); ?>-extra_days', <?php echo e($key); ?>)"
                                    ...
                                    data-placeholder="<?php echo e(__('messages.t_choose_delivery_time')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12" wire:key="<?php echo e(uid()); ?>">
                        <div
                            class="relative default-select2 <?php echo e($errors->first('add_upgrade.extra_days') ? 'select2-custom-has-error' : ''); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/gigs/options/steps/pricing.blade.php ENDPATH**/ ?>