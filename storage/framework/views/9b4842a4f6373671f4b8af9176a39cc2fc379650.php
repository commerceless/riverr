        ...
        <nav class="justify-between px-4 py-3 text-gray-700 border border-gray-100 rounded-lg shadow-sm sm:flex sm:px-5 bg-white dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none" aria-label="Breadcrumb">
            ...
            <ol class="sm:inline-flex items-center mb-3 space-x-1 md:space-x-3 md:rtl:space-x-reverse sm:mb-0 hidden">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg aria-hidden="true" class="w-4 h-4 text-gray-400 rtl:rotate-180" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <a href="<?php echo e(url('seller/portfolio')); ?>" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ltr:ml-2 md:rtl:mr-2 dark:text-zinc-300 dark:hover:text-white">
            ...
            <div>
                <a href="<?php echo e(url('seller/portfolio')); ?>" class="flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:bg-zinc-700 dark:shadow-none dark:border-zinc-700 dark:text-zinc-200 dark:hover:text-white dark:hover:bg-zinc-900 dark:hover:border-zinc-900">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="overflow-hidden rounded-lg bg-white dark:bg-zinc-800 shadow px-10 py-12 mb-6">
                    <div class="grid col-span-12 md:gap-x-6 gap-y-8">
                        ...
                        <div class="col-span-12">
                            <div wire:ignore>
                                <span class="mb-2 text-[0.8125rem] font-semibold tracking-wide flex items-center text-gray-700 dark:text-white"><?php echo e(__('messages.t_project_thumbnail')); ?></span>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => 'thumbnail','id' => 'uploader_thumbnail','extensions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['jpg', 'jpeg', 'png']),'accept' => 'image/jpg, image/jpeg, image/png','size' => ''.e(settings('media')->portfolio_max_size).'','max' => '1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="mt-1 text-xs text-red-600"><?php echo e($errors->first('thumbnail')); ?></p>
                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-3">
                                <img src="<?php echo e(src($project->thumbnail)); ?>" alt="<?php echo e($project->title); ?>" class="h-32 w-32 rounded-lg cursor-pointer object-cover">
                            </div>
                        ...
                        <div class="col-span-12">
                            <div wire:ignore>
                                <label class="mb-2 text-[0.8125rem] font-medium tracking-wide flex items-center <?php echo e($errors->first('images') ? 'text-red-600' : 'text-gray-700 dark:text-white'); ?>"><?php echo e(__('messages.t_project_images')); ?></label>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => 'images','id' => 'uploader_images','extensions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['jpg', 'jpeg', 'png']),'accept' => 'image/jpg, image/jpeg, image/png','size' => ''.e(settings('media')->portfolio_max_size).'','max' => ''.e(settings('media')->portfolio_max_images).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9eb2600c2d12964ae30115ef6c121fa79fa74a59)): ?>
<?php $component = $__componentOriginal9eb2600c2d12964ae30115ef6c121fa79fa74a59; ?>
                            ...
                            <div class="grid grid-cols-12 gap-x-4 gap-y-6">
                                <?php $__currentLoopData = $project->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-span-6">
                                        <img src="<?php echo e(src($img->image)); ?>" alt="<?php echo e($project->title); ?>" class="rounded-lg w-full h-32 object-cover intense cursor-pointer shadow-sm">
                                    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/portfolio/options/edit.blade.php ENDPATH**/ ?>