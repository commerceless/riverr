                        ...
                        <div class="flex items-center bg-slate-100 px-4 py-2 rounded dark:bg-zinc-600">
                            ...
                            <div class="ltr:ml-3 rtl:mr-3 w-0 flex-1">
                                ...
                                <div class="mt-2 flex space-x-7 rtl:space-x-reverse">
                                    ...
                                    <button wire:click="read('<?php echo e($n->uid); ?>')" wire:loading.attr="disabled" wire:target="read('<?php echo e($n->uid); ?>')" type="button" class="bg-transparent rounded-md text-gray-700 hover:text-gray-500 focus:outline-none text-xs tracking-wide dark:text-zinc-200 dark:hover:text-white">
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/partials/notifications.blade.php ENDPATH**/ ?>