            ...
            <table class="min-w-full text-sm align-middle whitespace-nowrap">
                ...
                <tbody>
                    <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr wire:key="trashed-gigs-<?php echo e($gig->uid); ?>">
                            ...
                            <td class="p-3 text-center">
                                <span class="text-gray-500 font-semibold text-[13px]"><?php echo e(format_date($gig->deleted_at)); ?></span>
                            </td>
                            ...
                            <td class="p-3 text-center">
                                <div class="space-x-4 rtl:space-x-reverse">
                                    ...
                                    <button type="button" wire:click="confirmRestore('<?php echo e($gig->id); ?>')" data-tooltip-target="tooltip-action-restore-<?php echo e($gig->id); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                                    ...
                                    <div id="tooltip-action-restore-<?php echo e($gig->id); ?>" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                        <?php echo e(__('messages.t_restore_gig')); ?>

                                    </div>

                                    
                                    <button type="button" wire:click="confirmDelete('<?php echo e($gig->id); ?>')" data-tooltip-target="tooltip-action-delete-<?php echo e($gig->id); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                                    ...
                                    <div id="tooltip-action-delete-<?php echo e($gig->id); ?>" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                        <?php echo e(__('messages.t_permanently_delete')); ?>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/gigs/trash/trash.blade.php ENDPATH**/ ?>