...
<?php endif; ?>
            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
					...
					<span class="sm:ltr:ml-3 sm:rtl:mr-3">
						<a href="<?php echo e(url('explore/projects')); ?>" class="inline-flex items-center rounded-sm border border-transparent bg-primary-600 px-4 py-2 text-[13px] font-semibold text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 space-y-8">
        <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="bg-white shadow-sm border rounded-md lg:flex lg:flex-row lg:divide-x dark:bg-zinc-800 dark:border-zinc-800 dark:shadow-none dark:divide-zinc-700 lg:rtl:divide-x-reverse divide-y lg:divide-y-0" wire:key="awarded-projects-<?php echo e($project->uid); ?>">
                ...
                <div class="shrink-0 w-full lg:w-56 rounded-t-md ltr:lg:rounded-l-md rtl:lg:rounded-r-md lg:ltr:rounded-tr-none lg:rtl:rounded-tl-none">
                    <div class="relative h-full">
                        <div class="flex grow flex-col items-center justify-center h-full px-4 pb-5 sm:px-5 pt-6">
                            ...
                            <div class="h-16 w-16">
                                <img class="object-cover object-center h-16 w-16 rounded-full" src="<?php echo e(src($project->client->avatar)); ?>" alt="<?php echo e($project->client->username); ?>">
                            </div>

                            
                            <?php if($project->client->fullname): ?>
                                <h3 class="pt-3 text-sm font-bold text-zinc-900 dark:text-zinc-100 flex items-center">
                                    <span><?php echo e($project->client->fullname); ?></span>  
                            ...
                            <p class="text-[13px] mt-1 font-medium text-zinc-500 dark:text-zinc-300"><?php echo e($project->client->username); ?></p>

                            
                            <div class="w-full mt-6">

                                
                                <a href="<?php echo e(url('profile', $project->client->username)); ?>" target="_blank" class="inline-flex items-center justify-center rounded-md border border-transparent bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none w-full">
                                    <?php echo app('translator')->get('messages.t_view_profile'); ?>
                                </a>
        
                                
                                <a href="<?php echo e(url('messages/new', $project->client->username)); ?>" target="_blank" class="mt-3 inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none w-full dark:bg-zinc-600 dark:border-zinc-600 dark:text-zinc-200 dark:hover:bg-zinc-700 dark:hover:text-zinc-200 dark:hover:border-zinc-600">
                ...
                <div class="flex w-full grow flex-col px-4 py-6 sm:px-5 justify-center">
                    ...
                    <div>
                        <a href="<?php echo e(url('project/' . $project->pid . '/' . $project->slug)); ?>" target="_blank" class="font-semibold md:text-lg text-zinc-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 flex">
                    ...
                    <p class="mt-1 line-clamp-3 leading-relaxed text-sm text-zinc-500 tracking-wide mb-2 dark:text-zinc-300">
                        <?php echo e(add_3_dots($project->description, 890)); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-accept-project-container-'.e($project->uid).'','target' => 'modal-accept-project-button-'.e($project->uid).'','uid' => 'modal_accept_uid_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                    
                     <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_confirmation')); ?> <?php $__env->endSlot(); ?>
                     ...
                     <?php $__env->slot('footer', null, []); ?> 
                        <div class="flex justify-between items-center w-full">
                            ...
                            <button
                                type="button" 
                                wire:click="accept('<?php echo e($project->uid); ?>')"
                                ...
                                <div wire:loading wire:target="accept('<?php echo e($project->uid); ?>')">
                                ...
                                <div wire:loading.remove wire:target="accept('<?php echo e($project->uid); ?>')">
                                    <?php echo app('translator')->get('messages.t_accept_the_project'); ?>
                                </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-reject-project-container-'.e($project->uid).'','target' => 'modal-reject-project-button-'.e($project->uid).'','uid' => 'modal_reject_uid_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-xl']); ?>
                            ...
                            <div class="col-span-12">
                                <fieldset class="w-full">
                                    <div class="space-y-4">
                                        ...
                                        <?php for($i = 1; $i <= 8; $i++): ?>
                                            <div class="flex items-center">
                                                <input wire:model.defer="reject_reason" value="reason_<?php echo e($i); ?>" id="freelancer_reject_project_reason_<?php echo e($i); ?>" name="reject_reason" type="radio" class="focus:ring-primary-600 h-4 w-4 text-primary-700 border-gray-300 dark:bg-zinc-500 dark:border-zinc-400 dark:ring-offset-zinc-600" />
                                                <label for="freelancer_reject_project_reason_<?php echo e($i); ?>" class="ltr:ml-3 rtl:mr-3 block text-sm font-medium text-gray-700 dark:text-white"> 
                                                    <?php echo e(__('messages.t_freelancer_reject_project_reason_' . $i)); ?>  
                                                </label>
                                            </div>
                                        <?php endfor; ?>
                     ...
                     <?php $__env->slot('footer', null, []); ?> 
                        <div class="flex justify-between items-center w-full">
                            ...
                            <button
                                type="button" 
                                wire:click="reject('<?php echo e($project->uid); ?>')"
                                wire:loading.attr="disabled"
                                class="inline-flex justify-center items-center rounded border font-semibold focus:outline-none px-3 py-2 leading-5 text-xs tracking-wide border-transparent bg-primary-600 text-white hover:bg-primary-700 focus:ring focus:ring-primary-500 focus:ring-opacity-25 disabled:bg-gray-200 disabled:hover:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed">
                                
                                
                                <div wire:loading wire:target="reject('<?php echo e($project->uid); ?>')">
                                    <svg role="status" class="inline w-4 h-4 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                        <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                    </svg>
                                ...
                                <div wire:loading.remove wire:target="reject('<?php echo e($project->uid); ?>')">
                                    <?php echo app('translator')->get('messages.t_reject_the_project'); ?>
                                </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-my-proposal-container-'.e($project->uid).'','target' => 'modal-my-proposal-button-'.e($project->uid).'','uid' => 'modal_my_proposal_uid_'.e($project->uid).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>

                    
                     <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_my_proposal')); ?> <?php $__env->endSlot(); ?>
                            ...
                            <div class="flex items-center text-sm font-normal text-gray-500 bg-gray-100 dark:bg-zinc-700 dark:text-zinc-400 px-3 py-2 rounded-md">
                                ...
                                <div>
                                    <?php if($project->awarded_bid->days === 1): ?>
                                        <?php echo e($project->awarded_bid->days); ?> <?php echo e(strtolower(__('messages.t_day'))); ?>

                                    <?php else: ?>
                                        <?php echo e($project->awarded_bid->days); ?> <?php echo e(strtolower(__('messages.t_days'))); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="border-dashed border-2 dark:border-zinc-500 rounded-md">
                <div class="py-14 px-6 text-center text-sm sm:px-14">
                    ...
                    <p class="mt-4 font-semibold text-gray-900 dark:text-zinc-300 text-[15px]"><?php echo e(__('messages.t_ur_projects_page_is_empty')); ?></p>
                    <p class="mt-2 text-gray-500 dark:text-zinc-400 max-w-md mx-auto"><?php echo e(__('messages.t_ur_projects_page_is_empty_subtitle')); ?></p>
                </div>
            </div>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/projects/projects.blade.php ENDPATH**/ ?>