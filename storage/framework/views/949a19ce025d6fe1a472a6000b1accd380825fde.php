                ...
                <div class="w-full">
                    <div id="app">
                        ...
                        <edit-project 
                            ...
                            _settings="<?php echo e($settings); ?>"
                            currency_symbol="<?php echo e($currency_symbol); ?>"
                            is_recaptcha="<?php echo e(settings('security')->is_recaptcha); ?>"
                            recaptcha_site_key="<?php echo e(config('recaptcha.site_key')); ?>" />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('livewire.main.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/account/projects/options/edit.blade.php ENDPATH**/ ?>