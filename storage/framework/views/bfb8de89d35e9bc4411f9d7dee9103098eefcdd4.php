...
<div x-data="window.XsPKiJSnOYqVlZD" @click.away="clear()" @keydown.escape="clear()">
    ...
    <label for="tags-input-component-id-<?php echo e($model); ?>" class="block text-xs font-semibold tracking-wide <?php echo e($errors->first($model) ? 'text-red-600' : 'text-gray-700 dark:text-gray-100'); ?>"><?php echo e(htmlspecialchars_decode($label)); ?></label>
    ...
    <div class="mt-2 relative flex items-center">
        ...
        <input 
            ...
            x-ref="value" 
            @keyup.enter="addTag()" 
            id="tags-input-component-id-<?php echo e($model); ?>" 
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/components/forms/tags-input.blade.php ENDPATH**/ ?>