...
<div class="<?php if($disabled): ?> opacity-60 <?php endif; ?>">
    <?php if($label || $cornerHint): ?>
        <div class="flex <?php echo e(!$label && $cornerHint ? 'justify-end' : 'justify-between items-end'); ?> mb-1">
            <?php if($label): ?>
...
<?php /**PATH /var/www/html/riverr/vendor/wireui/wireui/resources/views/components/input.blade.php ENDPATH**/ ?>