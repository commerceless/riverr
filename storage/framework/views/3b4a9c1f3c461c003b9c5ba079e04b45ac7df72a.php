        ...
        <div class="sm:flex items-center justify-between">
            ...
            <div class="space-x-3 rtl:space-x-reverse">
                ...
                <a href="<?php echo e(admin_url('gigs/trash')); ?>" class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded border font-semibold focus:outline-none px-2 py-3 leading-5 text-[13px] border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                    ...
                    <span><?php echo app('translator')->get('messages.t_deleted_gigs'); ?></span>
                </a>
        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800 dark:text-white ">
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_gig')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_price')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_visits')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_sales')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_in_queue')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_rating')); ?></th>
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_created_at')); ?></th>
            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="reports-<?php echo e($gig->id); ?>">

                        
                        <td class="ltr:pl-4 ltr:pr-10 rtl:pr-4 rtl:pl-10 w-[40%]">
                            <div class="flex items-center">
                                <div class="w-8 h-8">
                                    <img class="w-full h-full rounded object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($gig->thumbnail)); ?>" alt="<?php echo e($gig->title); ?>" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="<?php echo e(url('service', $gig->slug)); ?>" target="_blank" class="font-medium text-sm hover:text-primary-600 truncate pb-1.5 block max-w-xs"><?php echo e($gig->title); ?></a>
                        ...
                        <td class="text-center">
                            <p class="text-xs font-black text-black "><?php echo money($gig->price, settings('currency')->code, true); ?></p>
                        </td>

                        
                        <td class="text-center">
                            <p class="text-xs font-black text-black "><?php echo e($gig->counter_visits); ?></p>
                        </td>

                        
                        <td class="text-center">
                            <p class="text-xs font-black text-black "><?php echo e($gig->counter_sales); ?></p>
                        </td>

                        
                        <td class="text-center">
                            <p class="text-xs font-black text-black "><?php echo e($gig->orders_in_queue); ?></p>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="relative inline-block text-left">
                                <div>
                                    <button data-dropdown-toggle="table-options-dropdown-<?php echo e($gig->id); ?>" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                ...
                                <div id="table-options-dropdown-<?php echo e($gig->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">
                                        ...
                                        <button wire:key="option-delete-<?php echo e($gig->id); ?>" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this')); ?>') ? $wire.delete('<?php echo e($gig->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($gig->id); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
                                            ...
                                            <span class="text-xs font-medium"><?php echo e(__('messages.t_move_to_trash')); ?></span>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/gigs/gigs.blade.php ENDPATH**/ ?>