            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate sm:mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="freelancer-dashboard-refunds-<?php echo e($refund->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($refund->item->gig->thumbnail)); ?>" alt="<?php echo e($refund->item->gig->title); ?>">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(url('service', $refund->item->gig->slug)); ?>" class="font-medium whitespace-nowrap truncate block max-w-[240px] hover:text-primary-600 dark:text-white text-sm" title="<?php echo e($refund->item->gig->title); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-44 rtl:text-right">
                                <div class="flex items-center">
                                    <div class="h-10 w-10 flex-shrink-0">
                                        <img class="h-10 w-10 rounded-full lazy object-cover object-center" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($refund->buyer->avatar)); ?>" alt="<?php echo e($refund->buyer->username); ?>">
                                    </div>
                                    <div class="ltr:ml-4 rtl:mr-4">
                                        <a href="<?php echo e(url('profile', $refund->buyer->username)); ?>" target="_blank" class="font-medium text-gray-900 dark:text-gray-200 pb-1 hover:text-primary-600 block text-sm"><?php echo e($refund->buyer->username); ?></a>
                                        <div class="font-normal text-gray-500 dark:text-gray-300 text-xs">
                                            <?php if($refund->buyer->fullname): ?>
                                                <?php echo e($refund->buyer->fullname); ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <span class="text-[13px] font-medium text-gray-700 dark:text-gray-400">
                                    <?php echo e(format_date($refund->created_at, 'ago')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-contact-buyer-'.e($refund->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_contact_buyer'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <a href="<?php echo e(url('seller/refunds/details', $refund->uid)); ?>" data-tooltip-target="tooltip-actions-refund-details-<?php echo e($refund->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100" wire:key="tooltip-actions-refund-details-<?php echo e($refund->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-refund-details-'.e($refund->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_refund_details'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4)): ?>
<?php $component = $__componentOriginal90fbf2c6e499bdb3000b35d71910378103e092b4; ?>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/refunds/refunds.blade.php ENDPATH**/ ?>