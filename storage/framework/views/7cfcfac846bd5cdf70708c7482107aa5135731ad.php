				...
				<form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.fullname" class="<?php echo e($errors->first('fullname') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_your_fullname')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.username" class="<?php echo e($errors->first('username') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_username')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                            ...
                            <span class="text-xs tracking-wider text-gray-500"><?php echo app('translator')->get('messages.t_by_signup_u_agree_to_terms_privacy'); ?></span>
                        </div>
                    </div>
			...
			<div class="mt-6">
				<ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2">
					...
					<li>
						<a class="hover:text-slate-600 hover:underline" href="<?php echo e(url('auth/login')); ?>">
		...
		function UcZWcDFfVKBjfgP() {
			return {
				...
				register() {
					...
					// Register
					window.livewire.find('<?php echo e($_instance->id); ?>').register({
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/auth/register.blade.php ENDPATH**/ ?>