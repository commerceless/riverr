<div class="container" x-data="window.mTUkVVaUJscRImp" x-init="init()">
            ...
            <div class="wrapper">
                ...
                <div class="conversation-area rtl:!border-r-0 rtl:border-l border-gray-200 dark:border-zinc-700">
                    ...
                    <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(url('messages', $c->uid)); ?>" class="msg <?php echo e($c->sender->isOnline() ? 'online' : 'offline'); ?>" wire:key="conversation-id-<?php echo e($c->uid); ?>">
                            <img class="msg-profile rtl:!mr-0 rtl:!ml-4 lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($c->sender->avatar)); ?>" alt="<?php echo e($c->sender->username); ?>" />
                ...
                <div class="chat-area items-center justify-start pt-12" id="chat-area">
                    <div class="py-14 px-6 text-center text-sm sm:px-14">
                        ...
                        <p class="mt-4 font-semibold text-gray-900 dark:text-gray-200"><?php echo e(__('messages.t_no_conversation_selected')); ?></p>
                        <p class="mt-2 text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_no_conversation_selected_subtitle')); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-14 px-6 text-center text-sm sm:px-14 max-w-xl border-2 bg-slate-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700 m-auto border-dashed">
        ...
        <p class="mt-4 font-semibold text-gray-900 dark:text-white"><?php echo e(__('messages.t_no_conversations')); ?></p>
        <p class="mt-2 text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_u_dont_have_any_active_conversations')); ?></p>
    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/messages/messages.blade.php ENDPATH**/ ?>