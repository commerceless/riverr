...
<?php endif; ?>
        ...
        <div class="mx-auto max-w-7xl">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4 justify-between">
                    ...
                    <span class="block lg:ltr:ml-3 lg:rtl:pr-3">
                        <a href="<?php echo e(url('seller/withdrawals')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-500 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-600 dark:focus:ring-offset-zinc-500">
                            ...
                            <?php echo e(__('messages.t_payouts_history')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <main class="rounded-lg bg-white dark:bg-zinc-800 shadow border border-gray-200 dark:border-zinc-800 py-8 sm:py-12 px-6 sm:px-10" x-data="{ selected: '<?php echo e($selected); ?>' }">

            
            <div class="space-y-2 mb-10" x-cloak>
                <div class="block text-[0.8125rem] font-medium tracking-wide text-gray-700 dark:text-white"><?php echo e(__('messages.t_select_payout_method')); ?></div>
                <div class="mt-2 space-x-4 rtl:space-x-reverse">
                    ...
                    <?php if(boolval(config('payouts.paypal.enabled'))): ?>
                        <label class="inline-flex items-center">
                            ...
                            <span class="ltr:ml-2 rtl:mr-2 text-[13px] font-medium dark:text-gray-200">
                                <?php echo e(config('payouts.paypal.name')); ?>
                    ...
                    <?php if(boolval(config('payouts.offline.enabled'))): ?>
                        <label class="inline-flex items-center">
                            ...
                            <span class="ltr:ml-2 rtl:mr-2 text-[13px] font-medium dark:text-gray-200">
                                <?php echo e(config('payouts.offline.name')); ?>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/seller/withdrawals/settings.blade.php ENDPATH**/ ?>