...
<?php endif; ?>
                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_edit_review')); ?></h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_update_ur_review_for_this_gig')); ?></p>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('ELsVvPT')) {
    $componentId = $_instance->getRenderedChildComponentId('ELsVvPT');
    $componentTag = $_instance->getRenderedChildComponentTagName('ELsVvPT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ELsVvPT');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $review->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('ELsVvPT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/riverr/resources/views/livewire/main/account/reviews/options/edit.blade.php ENDPATH**/ ?>