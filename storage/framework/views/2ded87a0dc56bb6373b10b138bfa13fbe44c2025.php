    ...
    <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
        ...
        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4 rounded-t-md">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                ...
                <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_requirements')); ?></h3>
                <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_create_gig_requirements_subtitle')); ?></p>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-xs font-medium text-amber-700">
                                <?php echo e(__('messages.t_u_have_to_add_at_least_1_requirement')); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/riverr/resources/views/livewire/main/create/steps/requirements.blade.php ENDPATH**/ ?>