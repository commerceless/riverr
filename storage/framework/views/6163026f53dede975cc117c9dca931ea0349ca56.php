        ...
        <div class="py-4 text-gray-400 dark:text-gray-400">
            <ul class="space-y-3">
                ...
                <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(!$link['childs']): ?>
                        ...
                        <li class="relative px-4 flex items-center group">
                            <a href="<?php echo e($link['href']); ?>" class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100">
                                ...
                                <span class="ltr:ml-4 rtl:mr-4 text-[13px] font-medium text-gray-600 group-hover:text-gray-900"><?php echo e($link['text']); ?></span>
                                ...
                                <ul x-transition:enter="transition-all ease-in-out duration-300"
                                    ...
                                    <?php $__currentLoopData = $link['childs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                            <a class="w-full block font-medium" href="<?php echo e($child['href']); ?>"><?php echo e($child['text']); ?></a>
                                        </li>
                ...
                <li class="relative px-4 flex items-center group !mt-8">
                    <div class="text-xs font-normal text-gray-400 tracking-wider">v<?php echo e(config('global.version')); ?> ©<?php echo e(config('app.name')); ?></div>
                </li>
                    ...
                    <?php if(!$link['childs']): ?>
                        ...
                        <li class="relative px-4 flex items-center group">
                            <a href="<?php echo e($link['href']); ?>" class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100">
                                ...
                                <span class="ltr:ml-4 rtl:mr-4 text-xs font-medium text-gray-600 group-hover:text-gray-900"><?php echo e($link['text']); ?></span>
                        ...
                        <li class="relative px-4 group" x-data="{ open: false }">
                            <button
                                ...
                                <span class="inline-flex items-center">
                                    ...
                                    <span class="ml-4 rtl:mr-4 text-xs font-medium text-gray-600 group-hover:text-gray-900"><?php echo e($link['text']); ?></span>
...
</div><?php /**PATH /var/www/html/riverr/resources/views/livewire/admin/includes/sidebar.blade.php ENDPATH**/ ?>