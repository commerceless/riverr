    ...
    <div class="grid grid-cols-1 md:grid-cols-3 md:gap-5">
        ...
        <div class="bg-white shadow rounded-lg divide-y divide-gray-200 dark:divide-zinc-700 md:col-span-2 h-fit">
            <div class="py-10 px-12">
                ...
                {{-- Section header --}}
                <div class="mb-14">
                    <h2 class="text-sm leading-6 font-bold text-gray-900">{{ __('messages.t_edit_projects_category') }}</h2>
                </div>
                ...
                <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                    ...
                    <div class="col-span-12">
                        ...
                        @if ($category->thumbnail)
                            <div class="mt-3">
                                <img src="{{ src( $category->thumbnail ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-span-12">
                        ...
                        @if ($category->ogimage)
                            <div class="mt-3">
                                <img src="{{ src( $category->ogimage ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                            </div>
                        @endif
                    </div>
                    ...
                    @foreach ($translations as $key => $value)
                        ...
                        <li class="p-4 flex justify-between items-center" wire:key="translations-{{ $key }}">
                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                ...
                                {{-- Flag --}}
                                @if ($language)
                                    <img src="{{ placeholder_img() }}" data-src="{{ url('public/img/flags/rounded/' . $language->country_code . '.svg') }}" alt="{{ $language->name }}" class="inline-block w-10 h-10 rounded-full lazy" />
                                @endif
