<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            {{-- Section header --}}
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900">{{ __('messages.t_paystack_payment_settings') }}</h2>
                <p class="mt-1 text-xs text-gray-500">{{ __('messages.t_paystack_payment_settings_subtitle') }}</p>
            </div>
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                <div class="col-span-12">
                    ...
                    @if (settings('paystack')->logo)
                        <div class="mt-3">
                            <img src="{{ src( settings('paystack')->logo ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-12">
                    <x-forms.text-input
                        :label="__('messages.t_merchant_email_address')"
