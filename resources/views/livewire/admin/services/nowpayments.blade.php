    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                <div class="col-span-12">
                    <x-forms.text-input
                        :label="__('messages.t_crypto_currency')"
                        :placeholder="__('messages.t_enter_crypto_currency')"
                ...
                <div class="col-span-12">
                    ...
                    @if (settings('nowpayments')->logo)
                        <div class="mt-3">
                            <img src="{{ src( settings('nowpayments')->logo ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
