<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            {{-- Section header --}}
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900">{{ __('messages.t_edit_subcategory') }}</h2>
            </div>
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                <div class="col-span-6">
                    ...
                    @if ($subcategory->icon)
                        <div class="mt-3">
                            <img src="{{ src( $subcategory->icon ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-6">
                    ...
                    @if ($subcategory->image)
                        <div class="mt-3">
                            <img src="{{ src( $subcategory->image ) }}" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
