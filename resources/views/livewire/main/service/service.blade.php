                                    ...
                                    <ul class="splide__list">
                                        ...
                                        @endif
                                         ...
                                         @if ($gig->vimeo_video_id)
                                            <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain" data-splide-vimeo="https://player.vimeo.com/video{{ $gig->vimeo_video_id }}">
                                                <img src="{{ src($gig->imageLarge) }}" alt="{{ $gig->title }}" class=" object-contain">
                                            </li>
                                        @endif 
                        ...
                        <section id="thumbnail-carousel" class="splide">
                            <div class="splide__track">
                                    <ul class="splide__list">
                                        ...
                                        @if ($gig->vimeovideo_link)
                                            <li class="splide__slide !sr-only" data-splide-vimeo="{{ $gig->vimeo_video_link }}">
                                                <img src="{{ src($gig->thumbnail) }}" alt="{{ $gig->title }}" class=" object-cover">
                                            </li>
                                        @endif
