                ...
                <div class="lg:col-span-9">
                    <div class="max-w-lg mx-auto py-12">
                        ...
                        @if (!$isSucceeded)
                                ...
                                <div class="relative grid grid-cols-3 sm:gap-4 gap-y-4 mt-14" wire:key="deposit-key-select">
                                    ...
                                    @if (settings('epoint')->is_enabled)
                                        <div 
                                            ...
                                            {{-- Deposit fee --}}
                                            <span class="text-green-400 text-xs">{{ settings('epoint')->deposit_fee }}% {{ __('messages.t_fee') }}</span>
                            ...
                            {{-- Order summary --}}
                            @if (in_array($selected, ['cashfree', 'flutterwave', 'mercadopago', 'mollie', 'offline_payment', 'paymob', 'paypal', 'paystack', 'paytabs', 'paytr', 'razorpay', 'stripe', 'vnpay', 'xendit', 'jazzcash', 'youcanpay', 'nowpayments', 'epoint']))
