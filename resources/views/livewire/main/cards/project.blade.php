        ...
        <div class="grow">
            ...
            <div class="flex items-center mt-1">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-sm text-gray-400 dark:text-gray-300">{{ $total_bids }} {{ strtolower(__('messages.t_bids')) }}</span>
                </div>
                ...
                <div class="flex items-center ltr:ml-4 ltr:pl-4 ltr:border-l rtl:mr-4 rtl:pr-4 rtl:border-r border-gray-300 dark:border-zinc-600">
                    ...
                    @if ($budget_type === 'fixed')
                        <span class="text-sm text-gray-400 dark:text-gray-300">{{ __('messages.t_fixed_price') }}</span>
                    @else
                        <span class="text-sm text-gray-400 dark:text-gray-300">{{ __('messages.t_hourly_price') }}</span>
                    @endif
                </div>
                ...
                <div class="flex items-center ltr:ml-4 ltr:pl-4 ltr:border-l rtl:mr-4 rtl:pr-4 rtl:border-r border-gray-300 dark:border-zinc-600">
                    ...
                    <span class="text-sm text-gray-400 dark:text-gray-300">{{ $created_at }}</span>
                </div>
