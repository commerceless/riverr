                    ...
                    <div class="flex">
                        ...
                        <div class="ltr:ml-3 rtl:mr-3">
                            ...
                            <div class="mt-2 text-sm text-amber-700">
                                <span class="text-xs font-medium mb-3 block">{{ __('messages.t_this_user_is_not_available_right_now_msg', ['date' => format_date($user->availability->expected_available_date, config('carbon-formats.F_j,_Y'))]) }}</span>
                ...
                <div class="border-t-2 border-gray-100 dark:border-zinc-700 px-4 py-5 sm:p-0">
                    <dl class="sm:divide-y sm:divide-gray-100 dark:divide-zinc-700">
                        ...
                        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200 sm:mt-0 sm:col-span-2">
                                {{ format_date($user->created_at, config('carbon-formats.F_j,_Y')) }}
                            </dd>
                        </div>
