...
class CreateJazzcashTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('jazzcash_transactions', function (Blueprint $table) {
            ...
            $table->text('order')->comment('Order data fields and values');
            $table->text('request')->comment('Jazzcash request data fields and values');
            $table->text('response')->nullable()->comment('Jazzcash response data fields and values');
